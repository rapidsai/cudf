...
conda install -c nvidia -c rapidsai -c numba -c conda-forge -c defaults \
    cudf=$cudf_version python=3.6 cudatoolkit=9.2

# or, for CUDA 10.0
conda install -c nvidia -c rapidsai -c numba -c conda-forge -c defaults \
    cudf=$cudf_version python=3.6 cudatoolkit=10.0
```
...
# CUDA 9.2
conda install -c nvidia -c rapidsai -c numba -c conda-forge -c defaults cudf=$cudf_version

# CUDA 10.0
conda install -c nvidia/label/cuda10.0 -c rapidsai/label/cuda10.0 -c numba -c conda-forge -c defaults cudf=$cudf_version
