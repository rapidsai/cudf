...
if(PER_THREAD_DEFAULT_STREAM)
    message(STATUS "NVCOMP: Enabling per-thread default stream")
    list(APPEND NVCOMP_CMAKE_ARGS " -DCMAKE_C_FLAGS=-DCUDA_API_PER_THREAD_DEFAULT_STREAM")
    list(APPEND NVCOMP_CMAKE_ARGS " -DCMAKE_CXX_FLAGS=-DCUDA_API_PER_THREAD_DEFAULT_STREAM")
