...
JNIEXPORT jlong JNICALL Java_ai_rapids_cudf_ColumnView_containsVector(JNIEnv *env, jobject j_object,
  ...
  try {
    cudf::jni::auto_set_device(env);
    auto const search_space_ptr = reinterpret_cast<cudf::column_view *>(j_search_space_handle);
    auto const values_ptr = reinterpret_cast<cudf::column_view *>(j_values_handle);
