...
JNIEXPORT jboolean JNICALL Java_ai_rapids_cudf_ColumnView_hasNonEmptyNulls(
...
JNIEXPORT jboolean JNICALL Java_ai_rapids_cudf_ColumnView_mayHaveNonEmptyNulls(
    JNIEnv *env, jclass, jlong column_view_handle) {
  JNI_NULL_CHECK(env, column_view_handle, "column_view handle is null", 0);
  try {
    cudf::jni::auto_set_device(env);
