 ...
 */
static jlongArray
convert_table_for_return(JNIEnv *env, std::unique_ptr<cudf::experimental::table> &table_result,
...
JNIEXPORT jlongArray JNICALL Java_ai_rapids_cudf_Table_concatenate(JNIEnv *env, jclass clazz,
  ...
  try {
    ...
    std::unique_ptr<cudf::experimental::table> table_result =
        cudf::experimental::concatenate(to_concat);
...
JNIEXPORT jlongArray JNICALL Java_ai_rapids_cudf_Table_filter(JNIEnv *env, jclass,
  ...
  try {
    ...
    std::unique_ptr<cudf::experimental::table> result =
        cudf::experimental::apply_boolean_mask(*input, *mask);
    return cudf::jni::convert_table_for_return(env, result);
  }
  CATCH_STD(env, 0);
}
