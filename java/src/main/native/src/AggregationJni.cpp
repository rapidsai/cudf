  ...
  try {
    ...
    auto ret = [&] {
      ...
      switch (kind) {
        ...
        case 28: // RANK
          return cudf::make_rank_aggregation(cudf::rank_method::MIN, {}, null_policy::INCLUDE);
        case 29: // DENSE_RANK
          return cudf::make_rank_aggregation(cudf::rank_method::DENSE, {}, null_policy::INCLUDE);
