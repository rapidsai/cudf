...
JNIEXPORT jlongArray JNICALL Java_ai_rapids_cudf_ORCChunkedReader_readChunk(JNIEnv *env, jclass,
                                                                            jlong handle) {
  JNI_NULL_CHECK(env, handle, "handle is null", nullptr);
...
JNIEXPORT void JNICALL Java_ai_rapids_cudf_ORCChunkedReader_close(JNIEnv *env, jclass,
                                                                  jlong handle) {
  JNI_NULL_CHECK(env, handle, "handle is null", );
