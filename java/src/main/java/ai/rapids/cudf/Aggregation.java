...
abstract class Aggregation {
    ...
    static HLLAggregation HLL(int numRegistersPerSketch) {
        return new HLLAggregation(Kind.HLL, numRegistersPerSketch);
    }

    static MergeHLLAggregation mergeHLL(int numRegistersPerSketch) {
        return new MergeHLLAggregation(Kind.MERGE_HLL, numRegistersPerSketch);
    }
