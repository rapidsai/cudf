...
class TableChunk {
 public:
   ...
   */
  TableChunk(cudf::table_view table_view,
   ...
   */
  TableChunk(std::unique_ptr<rapidsmpf::PackedData> packed_data);
   ...
   */
  [[nodiscard]] TableChunk make_available(rapidsmpf::MemoryReservation& reservation);
   ...
   */
  [[nodiscard]] TableChunk copy(rapidsmpf::MemoryReservation& reservation) const;
