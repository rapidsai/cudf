...
int main()
{
  std::string_view id          = "@RTCX_EMBED_SCRIPT_ARG__ID@";
  auto file_paths              = split_string("@RTCX_EMBED_SCRIPT_ARG__FILE_PATHS@", ';');
  auto file_dests              = split_string("@RTCX_EMBED_SCRIPT_ARG__FILE_DESTS@", ';');
  auto include_directories     = split_string("@RTCX_EMBED_SCRIPT_ARG__INCLUDE_DIRS@", ';');
  std::string_view compression = "@RTCX_EMBED_SCRIPT_ARG__COMPRESSION@";
  std::string_view output_dir  = "@RTCX_EMBED_SCRIPT_ARG__OUTPUT_DIR@";
