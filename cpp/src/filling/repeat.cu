                              ...
                              rmm::mr::device_memory_resource* mr)
{
  ...
  return gather(
    input_table, indices.begin(), indices.end(), out_of_bounds_policy::DONT_CHECK, mr, stream);
}
                              ...
                              rmm::mr::device_memory_resource* mr)
{
  ...
  return gather(input_table, map_begin, map_end, out_of_bounds_policy::DONT_CHECK, mr, stream);
}
