                     ...
                     rmm::cuda_stream_view stream)
{
  ...
  row_hasher<default_hash> hasher{d_keys, keys_have_nulls};
  row_equality_comparator rows_equal{d_keys, d_keys, keys_have_nulls, null_keys_are_equal};
