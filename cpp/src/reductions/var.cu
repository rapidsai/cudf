...
std::unique_ptr<cudf::scalar> cudf::experimental::reduction::variance(column_view const& col, cudf::data_type const output_dtype, cudf::size_type ddof, cudaStream_t stream,
