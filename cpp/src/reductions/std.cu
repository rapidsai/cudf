    ...
    rmm::mr::device_memory_resource* mr, cudaStream_t stream)
{
  ...
  using reducer = cudf::experimental::reduction::compound::element_type_dispatcher< cudf::experimental::reduction::op::standard_deviation, cudf::experimental::aggregation::STD>;
