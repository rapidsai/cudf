                                            ...
                                            rmm::device_async_resource_ref mr)
{
  ...
  auto str_counter                = cudf::numeric_scalar(
    size_type{0}, true, stream, cudf::get_current_device_resource_ref_unsafe());
  ...
  rmm::device_async_resource_ref mr)
{
  ...
  auto d_null_count = cudf::detail::device_scalar<size_type>(
    null_count, stream, cudf::get_current_device_resource_ref_unsafe());
  auto null_count_data = d_null_count.data();
