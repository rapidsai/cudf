    ...
    _def_level(0, stream)
{
  ...
  _d_nullability =
    cudf::detail::make_device_uvector_async(_nullability, stream, resources.get_temporary_mr());
...
{
  auto d_partitions =
    cudf::detail::make_device_uvector_async(partitions, stream, resources.get_temporary_mr());
...
{
  auto d_frag_sz =
    cudf::detail::make_device_uvector_async(frag_sizes, stream, resources.get_temporary_mr());
                                   ...
                                   rmm::cuda_stream_view stream)
{
  ...
  auto d_part_frag_offset =
    cudf::detail::make_device_uvector_async(part_frag_offset, stream, resources.get_temporary_mr());
