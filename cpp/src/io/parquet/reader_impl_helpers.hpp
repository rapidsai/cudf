 ...
 * @param assert_if_not_found Whether to assert when no matching column chunk is found
 * @return Offset of the matching column chunk, if found
 */
[[nodiscard]] std::optional<size_type> find_colchunk_iter_offset(
