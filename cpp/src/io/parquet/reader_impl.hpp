...
class reader_impl {
 ...
 protected:
  ...
  {
    return (options.get_column_names().has_value() or options.get_column_indices().has_value() or
   ...
   */
  [[nodiscard]] bool effective_ignore_missing_columns(parquet_reader_options const& options) const
  {
