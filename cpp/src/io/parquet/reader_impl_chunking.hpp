...
struct file_intermediate_data {
  ...
  size_t num_input_row_groups{0};           // number of input row groups across all data sources
  size_t num_stats_filtered_row_groups{0};  // number of row groups after applying stats filter
  size_t num_bloom_filtered_row_groups{0};  // number of row groups after applying bloom filter
