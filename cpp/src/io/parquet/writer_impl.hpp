...
class writer::impl {
 ...
 private:
  ...
  size_t max_rowgroup_size           = default_rowgroup_size_bytes;
  size_type max_rowgroup_rows        = default_rowgroup_size_rows;
  size_t target_page_size            = default_page_size_bytes;
