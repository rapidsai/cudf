...
// std::vector<metadata::OrcStripeInfo> metadata::select_stripes(const std::vector<size_type>
// &stripes,
//                                                               size_type &row_start,
//                                                               size_type &row_count)
// {
...
//     } else {
//       row_count = static_cast<size_type>(std::min<size_t>(get_total_rows() - row_start,
//       row_count));
//     }
...
//       CUDF_EXPECTS(sf_comp_offset + sf_comp_length < source->size(), "Invalid stripe
//       information");
