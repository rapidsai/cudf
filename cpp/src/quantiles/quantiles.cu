...
// kernel for computing percentils on input tdigest (mean, weight) centroid data.
                                                   ...
                                                   rmm::mr::device_memory_resource* mr)
{
  ...
  CUDF_EXPECTS(percentages.type().id() == type_id::FLOAT64,
               "Encountered non-double percentages column in percentile_approx");
