...
{
  CUDF_FUNC_RANGE();
  return detail::extract_year(column, 0, mr);
}
...
{
  CUDF_FUNC_RANGE();
  return detail::extract_minute(column, 0, mr);
}
...
{
  CUDF_FUNC_RANGE();
  return detail::extract_second(column, 0, mr);
}
