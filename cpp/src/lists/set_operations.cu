                                     ...
                                     rmm::device_async_resource_ref mr)
{
  ...
  auto const lhs_labels =
    generate_labels(lhs, lhs_child.size(), stream, cudf::get_current_device_resource_ref_unsafe());
  auto const rhs_labels =
    generate_labels(rhs, rhs_child.size(), stream, cudf::get_current_device_resource_ref_unsafe());
  ...
  auto const contained = cudf::detail::contains(lhs_table,
                                                rhs_table,
                                                nulls_equal,
                                                nans_equal,
                                                stream,
                                            ...
                                            rmm::device_async_resource_ref mr)
{
  ...
  auto const contained = cudf::detail::contains(rhs_table,
                                                lhs_table,
                                                nulls_equal,
                                                nans_equal,
                                                stream,
