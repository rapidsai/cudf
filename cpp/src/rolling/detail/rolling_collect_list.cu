                                                           ...
                                                           rmm::cuda_stream_view stream)
{
  ...
  thrust::fill_n(rmm::exec_policy(stream, resources.get_temporary_mr()), per_row_mapping_begin, num_child_rows, 0);
                            ...
                            rmm::cuda_stream_view stream)
{
  ...
  return thrust::count_if(rmm::exec_policy(stream, resources.get_temporary_mr()),
