...
std::unique_ptr<column> binary_operation(scalar const& lhs,
  ...
  auto out = cudf::experimental::detail::make_numeric_column(output_type, rhs.size(), new_mask,
...
std::unique_ptr<column> binary_operation(column_view const& lhs,
  ...
  auto out = cudf::experimental::detail::make_numeric_column(output_type, lhs.size(), new_mask,
                                 cudf::UNKNOWN_NULL_COUNT, stream, mr);
...
std::unique_ptr<column> binary_operation(column_view const& lhs,
  ...
  auto out = cudf::experimental::detail::make_fixed_width_column(output_type, lhs.size(), new_mask,
                                     cudf::UNKNOWN_NULL_COUNT, stream, mr);
