...
struct dispatch_clamp {
    ...
    rmm::mr::device_memory_resource* mr = rmm::mr::get_current_device_resource())
  {
    ...
    auto lo_itr         = make_optional_iterator<T, nullate::YES>(lo);
    auto hi_itr         = make_optional_iterator<T, nullate::YES>(hi);
    auto lo_replace_itr = make_optional_iterator<T, nullate::NO>(lo_replace);
    auto hi_replace_itr = make_optional_iterator<T, nullate::NO>(hi_replace);
