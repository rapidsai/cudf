                                                             ...
                                                             size_type row_index)
{
  switch (col.type().id()) {
    ...
    case type_id::TIMESTAMP_SECONDS:
      return murmur_jit_hasher<id_to_type<type_id::TIMESTAMP_SECONDS>>(col, seed, nullable, row_index);
    case type_id::TIMESTAMP_MILLISECONDS:
      return murmur_jit_hasher<id_to_type<type_id::TIMESTAMP_MILLISECONDS>>(col, seed, nullable, row_index);
    case type_id::TIMESTAMP_MICROSECONDS:
      return murmur_jit_hasher<id_to_type<type_id::TIMESTAMP_MICROSECONDS>>(col, seed, nullable, row_index);
    case type_id::TIMESTAMP_NANOSECONDS:
      return murmur_jit_hasher<id_to_type<type_id::TIMESTAMP_NANOSECONDS>>(col, seed, nullable, row_index);
    ...
    case type_id::DURATION_SECONDS:
      return murmur_jit_hasher<id_to_type<type_id::DURATION_SECONDS>>(col, seed, nullable, row_index);
    case type_id::DURATION_MILLISECONDS:
      return murmur_jit_hasher<id_to_type<type_id::DURATION_MILLISECONDS>>(col, seed, nullable, row_index);
    case type_id::DURATION_MICROSECONDS:
      return murmur_jit_hasher<id_to_type<type_id::DURATION_MICROSECONDS>>(col, seed, nullable, row_index);
    case type_id::DURATION_NANOSECONDS:
      return murmur_jit_hasher<id_to_type<type_id::DURATION_NANOSECONDS>>(col, seed, nullable, row_index);
