                            ...
                            cudf::memory_resources resources)
{
  ...
  return detail::sort_by_key(input, input, column_order, null_precedence, stream, resources);
}
...
{
  CUDF_FUNC_RANGE();
  return detail::sorted_order(input, column_order, null_precedence, stream, resources);
}
...
{
  CUDF_FUNC_RANGE();
  return detail::sort(input, column_order, null_precedence, stream, resources);
}
...
{
  CUDF_FUNC_RANGE();
  return detail::sort_by_key(values, keys, column_order, null_precedence, stream, resources);
}
