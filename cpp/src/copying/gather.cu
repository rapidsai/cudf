...
struct bounds_checker {
  ...
  bounds_checker(size_type begin_, size_type end_) : begin{begin_}, end{end_} {}
...
/*
#define INSTANTIATE_(MapIterator)                 \
 template void gather_bitmask(table_device_view, \
                              MapIterator,       \
                              bitmask_type**,    \
                              size_type,         \
                              size_type,         \
...
#define INSTANTIATE(MapIterator)                                      \
  template void gather_bitmask(table_view const&,                     \
                               MapIterator,                           \
