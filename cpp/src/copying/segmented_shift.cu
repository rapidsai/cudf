...
struct segmented_shift_functor<T, std::enable_if_t<is_rep_layout_compatible<T>()>> {
                                     ...
                                     rmm::mr::device_memory_resource* mr)
  {
    ...
    auto input_iterator     = cudf::detail::make_optional_iterator<T, nullate::DYNAMIC>(
                            *values_device_view, segmented_values.has_nulls()) -
                          offset;
    auto fill_iterator = cudf::detail::make_optional_iterator<T, nullate::YES>(fill_value);
...
struct segmented_shift_functor<string_view> {
  ...
  {
    auto values_device_view = column_device_view::create(segmented_values, stream);
    auto input_iterator     = make_optional_iterator<cudf::string_view, nullate::DYNAMIC>(
                            *values_device_view, segmented_values.has_nulls()) -
                          offset;
    auto fill_iterator = make_optional_iterator<cudf::string_view, nullate::YES>(fill_value);
