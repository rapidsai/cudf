...
struct copy_if_else_functor_impl<T, std::enable_if_t<is_rep_layout_compatible<T>()>> {
                                     ...
                                     rmm::mr::device_memory_resource* mr)
  {
    ...
    auto lhs_iter = cudf::detail::make_optional_iterator<T, nullate::DYNAMIC>(lhs, left_nullable);
    auto rhs_iter = cudf::detail::make_optional_iterator<T, nullate::DYNAMIC>(rhs, right_nullable);
