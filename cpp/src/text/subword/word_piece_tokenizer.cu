...
word_piece_tokenizer::word_piece_tokenizer(std::string const& vocab_file,
...
void word_piece_tokenizer::tokenize(ptr_length_pair& cp_and_length,
                                    ...
                                    cudaStream_t stream)
{
  ...
  detail::gpuWordPieceTokenizer<<<num_wp_blocks, wp_threads_per_block, 0, stream>>>(
    device_code_points,
