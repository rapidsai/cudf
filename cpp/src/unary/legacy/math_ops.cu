  ...
  switch (op) {
    case unary_op::SIN:
      cudf::type_dispatcher(
        input.dtype, detail::MathOpDispatcher<detail::DeviceSin>{}, &input, &output);
      break;
    case unary_op::COS:
      cudf::type_dispatcher(
        input.dtype, detail::MathOpDispatcher<detail::DeviceCos>{}, &input, &output);
      break;
    case unary_op::TAN:
      cudf::type_dispatcher(
        input.dtype, detail::MathOpDispatcher<detail::DeviceTan>{}, &input, &output);
      break;
    case unary_op::ARCSIN:
      cudf::type_dispatcher(
        input.dtype, detail::MathOpDispatcher<detail::DeviceArcSin>{}, &input, &output);
      break;
    case unary_op::ARCCOS:
      cudf::type_dispatcher(
        input.dtype, detail::MathOpDispatcher<detail::DeviceArcCos>{}, &input, &output);
      break;
    case unary_op::ARCTAN:
      cudf::type_dispatcher(
        input.dtype, detail::MathOpDispatcher<detail::DeviceArcTan>{}, &input, &output);
      break;
    case unary_op::EXP:
      cudf::type_dispatcher(
        input.dtype, detail::MathOpDispatcher<detail::DeviceExp>{}, &input, &output);
      break;
    case unary_op::LOG:
      cudf::type_dispatcher(
        input.dtype, detail::MathOpDispatcher<detail::DeviceLog>{}, &input, &output);
      break;
    case unary_op::SQRT:
      cudf::type_dispatcher(
        input.dtype, detail::MathOpDispatcher<detail::DeviceSqrt>{}, &input, &output);
      break;
    case unary_op::CEIL:
      cudf::type_dispatcher(
        input.dtype, detail::MathOpDispatcher<detail::DeviceCeil>{}, &input, &output);
      break;
    case unary_op::FLOOR:
      cudf::type_dispatcher(
        input.dtype, detail::MathOpDispatcher<detail::DeviceFloor>{}, &input, &output);
      break;
    case unary_op::ABS:
      cudf::type_dispatcher(
        input.dtype, detail::MathOpDispatcher<detail::DeviceAbs>{}, &input, &output);
      break;
    case unary_op::BIT_INVERT:
      cudf::type_dispatcher(
        input.dtype, detail::BitwiseOpDispatcher<detail::DeviceInvert>{}, &input, &output);
      break;
    case unary_op::NOT:
      cudf::type_dispatcher(
        input.dtype, detail::LogicalOpDispatcher<detail::DeviceNot>{}, &input, &output);
      break;
