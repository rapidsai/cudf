...
class reprog_device {
 public:
   ...
   */
  [[nodiscard]] __device__ bool is_empty() const { return insts_counts() == 0 || get_inst(0)->type == END; }

  /**
   * @brief Returns the number of regex groups found in the expression.
   */
  [[nodiscard]] __host__ __device__ inline int32_t group_counts() const { return _num_capturing_groups; }
