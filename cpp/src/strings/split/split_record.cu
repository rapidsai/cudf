                                        ...
                                        cudf::memory_resources resources)
{
  ...
  auto strings_child = make_strings_column(tokens.begin(), tokens.end(), stream, resources);
                                     ...
                                     cudf::memory_resources resources)
{
  ...
  if (delimiter.size() == 0) {
    ...
    return split_record_fn(input, tokenizer, delimiter_fn, stream, resources);
  }
...
{
  CUDF_FUNC_RANGE();
  return detail::split_record(input, delimiter, maxsplit, stream, resources);
}
...
{
  CUDF_FUNC_RANGE();
  return detail::rsplit_record(input, delimiter, maxsplit, stream, resources);
}
