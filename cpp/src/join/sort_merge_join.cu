...
class merge {
 ...
 public:
  ...
  std::unique_ptr<rmm::device_uvector<size_type>> matches_per_row(rmm::cuda_stream_view stream,
                                                        ...
                                                        cudf::memory_resources resources)
{
  ...
  auto match_counts          = cudf::detail::make_zeroed_device_uvector_async<size_type>(
    larger_numrows + 1, stream, resources.get_temporary_mr());
                            ...
                            cudf::memory_resources resources)
{
  ...
  return invoke_merge(
    ...
    [this, stream, &resources](auto& obj) {
...
cudf::join_match_context sort_merge_join::inner_join_match_context(table_view const& left,
                                                                   sorted is_left_sorted,
                                                                   rmm::cuda_stream_view stream,
                                                                   cudf::memory_resources resources)
{
  ...
  return invoke_merge(
    preprocessed_right._null_processed_table_view,
    preprocessed_left._null_processed_table_view,
    [this, left, stream, &resources](auto& obj) {
                                        ...
                                        cudf::memory_resources resources)
{
  ...
  auto [preprocessed_right_indices, preprocessed_left_indices] = invoke_merge(
    ...
    [this, left_partition_start_idx, stream, &resources](auto& obj) {
      return obj(stream, resources);
    },
    stream);
