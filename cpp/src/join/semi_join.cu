  ...
  rmm::mr::device_memory_resource* mr = rmm::mr::get_current_device_resource())
{
  ...
  row_hash hash_build{*right_rows_d, true};
  row_equality equality_build{
    *right_rows_d, *right_rows_d, true, compare_nulls == null_equality::EQUAL};

  // Going to join it with left table
  auto left_rows_d = table_device_view::create(left_flattened_keys, stream);
  row_hash hash_probe{*left_rows_d, true};
  row_equality equality_probe{
    *left_rows_d, *right_rows_d, true, compare_nulls == null_equality::EQUAL};
