...
class fixed_point {
 ...
 public:
   ...
   */
  CUDA_HOST_DEVICE_CALLABLE
  fixed_point() : _scale{scale_type{0}} {}
   ...
   */
  [[nodiscard]] CUDA_HOST_DEVICE_CALLABLE rep value() const { return _value; }
   ...
   */
  [[nodiscard]] CUDA_HOST_DEVICE_CALLABLE scale_type scale() const { return _scale; }
