 ...
 * CUDA-supported input types are fixed-width, string, and dictionary types. PTX-supported input
 * types are fixed-width and dictionary types. CUDA-supported output types are fixed-width and
 * string types. PTX-supported output types are fixed-width types.
