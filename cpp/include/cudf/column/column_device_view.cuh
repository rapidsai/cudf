...
class alignas(16) column_device_view_base {
 public:
   ...
   */
  [[nodiscard]] __host__ __device__ [[nodiscard]] bool nullable() const noexcept { return nullptr != _null_mask; }
   ...
   */
  [[nodiscard]] __host__ __device__ [[nodiscard]] bitmask_type const* null_mask() const noexcept { return _null_mask; }

  /**
   * @brief Returns the index of the first element relative to the base memory
   * allocation, i.e., what is returned from `head<T>()`.
   */
  [[nodiscard]] __host__ __device__ [[nodiscard]] size_type offset() const noexcept { return _offset; }
   ...
   * @return false The element is null
   */
  [[nodiscard]] __device__ [[nodiscard]] bool is_valid_nocheck(size_type element_index) const noexcept
  {
   ...
   * @return false The element is valid
   */
  [[nodiscard]] __device__ [[nodiscard]] bool is_null_nocheck(size_type element_index) const noexcept
  {
   ...
   */
  [[nodiscard]] __device__ [[nodiscard]] bitmask_type get_mask_word(size_type word_index) const noexcept
  {
...
class alignas(16) column_device_view : public detail::column_device_view_base {
 ...
 public:
   ...
   */
  [[nodiscard]] __device__ [[nodiscard]] column_device_view child(size_type child_index) const noexcept
  {
   ...
   */
  [[nodiscard]] __device__ [[nodiscard]] device_span<column_device_view const> children() const noexcept
  {
   ...
   */
  [[nodiscard]] __host__ __device__ [[nodiscard]] size_type num_child_columns() const noexcept { return _num_children; }
...
class alignas(16) mutable_column_device_view : public detail::column_device_view_base {
 public:
   ...
   * @return column_view The requested child `column_view`
   */
  [[nodiscard]] __device__ [[nodiscard]] mutable_column_device_view child(size_type child_index) const noexcept
  {
    return d_children[child_index];
  }
