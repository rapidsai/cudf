 ...
 **/
rmm::device_buffer copy_bitmask(
  column_view const& view, rmm::mr::device_memory_resource* mr = rmm::mr::get_default_resource());
...
rmm::device_buffer bitmask_and(
  table_view const& view, rmm::mr::device_memory_resource* mr = rmm::mr::get_default_resource());
