...
/*inline*/ static constexpr last_spec last{};
/*inline*/ static constexpr weekday   Sunday{0};
/*inline*/ static constexpr weekday   Monday{1};
/*inline*/ static constexpr weekday   Tuesday{2};
/*inline*/ static constexpr weekday   Wednesday{3};
/*inline*/ static constexpr weekday   Thursday{4};
/*inline*/ static constexpr weekday   Friday{5};
/*inline*/ static constexpr weekday   Saturday{6};

/*inline*/ static constexpr month January{1};
/*inline*/ static constexpr month February{2};
/*inline*/ static constexpr month March{3};
/*inline*/ static constexpr month April{4};
/*inline*/ static constexpr month May{5};
/*inline*/ static constexpr month June{6};
/*inline*/ static constexpr month July{7};
/*inline*/ static constexpr month August{8};
/*inline*/ static constexpr month September{9};
/*inline*/ static constexpr month October{10};
/*inline*/ static constexpr month November{11};
/*inline*/ static constexpr month December{12};
