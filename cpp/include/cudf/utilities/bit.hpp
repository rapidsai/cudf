...
template <typename T>
constexpr CUDF_HDI std::size_t size_in_bits()
{
 ...
 */
constexpr CUDF_HDI size_type word_index(size_type bit_index)
{
 ...
 */
constexpr CUDF_HDI size_type intra_word_index(size_type bit_index)
{
  return bit_index % detail::size_in_bits<bitmask_type>();
}
 ...
 */
CUDF_HDI void set_bit_unsafe(bitmask_type* bitmask, size_type bit_index)
{
 ...
 */
CUDF_HDI void clear_bit_unsafe(bitmask_type* bitmask, size_type bit_index)
{
  assert(nullptr != bitmask);
  bitmask[word_index(bit_index)] &= ~(bitmask_type{1} << intra_word_index(bit_index));
}
 ...
 */
CUDF_HDI bool bit_is_set(bitmask_type const* bitmask, size_type bit_index)
{
  assert(nullptr != bitmask);
 ...
 */
CUDF_HDI bool bit_value_or(bitmask_type const* bitmask, size_type bit_index, bool default_value)
{
 ...
 */
constexpr CUDF_HDI bitmask_type set_least_significant_bits(size_type n)
{
 ...
 */
constexpr CUDF_HDI bitmask_type set_most_significant_bits(size_type n)
{
