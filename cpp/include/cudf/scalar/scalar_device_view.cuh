...
class scalar_device_view_base {
 public:
   ...
   */
  [[nodiscard]] __device__ [[nodiscard]] bool is_valid() const noexcept { return *_is_valid; }
...
class string_scalar_device_view : public detail::scalar_device_view_base {
 public:
   ...
   */
  [[nodiscard]] __device__ [[nodiscard]] ValueType value() const noexcept { return ValueType{this->data(), _size}; }

  /**
   * @brief Returns a raw pointer to the value in device memory
   */
  [[nodiscard]] __device__ [[nodiscard]] char const* data() const noexcept { return static_cast<char const*>(_data); }

  /**
   * @brief Returns the size of the string in bytes.
   */
  [[nodiscard]] __device__ [[nodiscard]] size_type size() const noexcept { return _size; }
