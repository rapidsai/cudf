...
struct unbound_list_view {
   ...
   */
  CUDF_DI unbound_list_view(label_type scatter_source_label,
   ...
   */
  CUDF_DI label_type label() const { return _label; }

  /**
   * @brief Returns the index in the source/target column
   */
  CUDF_DI size_type row_index() const { return _row_index; }
   ...
   */
  CUDF_DI list_device_view bind_to_column(lists_column_device_view const& scatter_source,
