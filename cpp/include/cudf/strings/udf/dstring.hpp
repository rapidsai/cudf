...
/**
 * @file
 * @brief Class definition for cudf::strings::udf::dstring.
 */
...
class dstring {
 public:
   ...
   */
  __device__ dstring(char const* data, cudf::size_type bytes);
   ...
   *             character array.
   */
  __device__ dstring(char const* data);
   ...
   */
  __device__ dstring(cudf::string_view const& str);
   ...
   */
  __device__ dstring(cudf::size_type count, cudf::char_utf8 chr);
   ...
   */
  __device__ dstring(dstring const& src);
   ...
   * @param src String to copy
   */
  __device__ dstring(dstring&& src);

  __device__ ~dstring();

  __device__ dstring& operator=(dstring const&);
  __device__ dstring& operator=(dstring&&);
  __device__ dstring& operator=(cudf::string_view const&);
  __device__ dstring& operator=(char const*);
  ...
  /**
   * @brief Return the maximum number of bytes a dstring can hold.
   */
   ...
   */
  __device__ dstring& assign(dstring&& str);
   ...
   * @return This string new contents
   */
  __device__ dstring& assign(cudf::string_view const& str);
   ...
   * @return This string new contents
   */
  __device__ dstring& assign(char const* str);
   ...
   * @return This string new contents
   */
  __device__ dstring& assign(char const* str, cudf::size_type bytes);
   ...
   */
  __device__ dstring& operator+=(cudf::string_view const& str);
   ...
   * @return This string with the appended argument
   */
  __device__ dstring& operator+=(cudf::char_utf8 chr);
   ...
   * @return This string with the appended argument
   */
  __device__ dstring& operator+=(char const* str);
   ...
   * @return This string with the appended argument
   */
  __device__ dstring& append(char const* str);
   ...
   * @return This string with the appended argument
   */
  __device__ dstring& append(char const* str, cudf::size_type bytes);
   ...
   * @return This string with the appended argument
   */
  __device__ dstring& append(cudf::string_view const& str);
   ...
   */
  __device__ dstring& append(cudf::char_utf8 chr, cudf::size_type count = 1);
   ...
   */
  __device__ dstring& insert(cudf::size_type pos, cudf::string_view const& str);
   ...
   * @return This string with the inserted argument
   */
  __device__ dstring& insert(cudf::size_type pos, char const* data);
   ...
   * @return This string with the inserted argument
   */
  __device__ dstring& insert(cudf::size_type pos, char const* data, cudf::size_type bytes);
   ...
   * @return This string with the inserted argument
   */
  __device__ dstring& insert(cudf::size_type pos, cudf::size_type count, cudf::char_utf8 chr);
   ...
   */
  __device__ dstring substr(cudf::size_type pos, cudf::size_type count = npos) const;
   ...
   */
  __device__ dstring& replace(cudf::size_type pos,
   ...
   * @return This string modified with the replacement
   */
  __device__ dstring& replace(cudf::size_type pos, cudf::size_type count, char const* data);
   ...
   */
  __device__ dstring& erase(cudf::size_type pos, cudf::size_type count = npos);
