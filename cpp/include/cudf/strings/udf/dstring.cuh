...
{
  m_bytes = m_capacity = cudf::strings::detail::bytes_in_null_terminated_string(data);
  m_data               = allocate(m_capacity);
...
{
  return assign(str, cudf::strings::detail::bytes_in_null_terminated_string(str));
}
...
{
  return append(str, cudf::strings::detail::bytes_in_null_terminated_string(str));
}
...
{
  return insert(pos, str, cudf::strings::detail::bytes_in_null_terminated_string(str));
}
...
__device__ inline dstring& dstring::replace(cudf::size_type pos,
                                            ...
                                            char const* str)
{
  return replace(pos, count, str, cudf::strings::detail::bytes_in_null_terminated_string(str));
}
