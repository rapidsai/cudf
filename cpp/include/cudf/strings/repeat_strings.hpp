...
/**
 * @brief Repeat each string in the given strings column by the numbers of times given in a
 * numeric column.
 *
 ...
 * @param output_strings_sizes The column containing pre-computed sizes of the output strings.
 * @param mr Device memory resource used to allocate the returned strings column.
 * @return New column containing the repeated strings.
 */
std::unique_ptr<column> repeat_strings(
...
/**
 * @brief Compute the sizes of the output strings if repeat each string in the input strings column
 * by the numbers of times given in a numeric column.
 *
 * @code{.pseudo}
 * Example:
 * strs         = ['aa', null, '', 'bbc-']
 ...
 *        are repeated.
 * @param mr Device memory resource used to allocate the returned strings column.
 * @return A pair of int32_t column containing sizes of the output strings, and a size_t number
 *         containing their total size.
 */
