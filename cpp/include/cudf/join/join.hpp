...
/**
 * @brief Sentinel value used to indicate an invalid or unmatched row index in join operations.
 *
 ...
 * from the right table, if there is a match  or  (2) `JoinNoneValue`.
 *
 * @code{.pseudo}
 * Left: {{0, 1, 2}}
 * Right: {{1, 2, 3}}
 ...
 * right tables, (2) a row index and `JoinNoneValue`,
