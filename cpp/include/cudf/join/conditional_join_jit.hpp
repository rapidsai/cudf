 ...
 * @param binary_predicate_udf The condition on which to join
...
conditional_inner_join_jit(
  table_view const& left,
  table_view const& right,
  std::string const& binary_predicate_udf,
 ...
 * `right` .
 */
std::unique_ptr<rmm::device_uvector<size_type>> conditional_left_semi_join_jit(
  table_view const& left,
  table_view const& right,
  std::string const& binary_predicate_udf,
  std::optional<std::size_t> output_size = {},
 ...
 * `right` .
 */
std::unique_ptr<rmm::device_uvector<size_type>> conditional_left_anti_join_jit(
  table_view const& left,
  table_view const& right,
  std::string const& binary_predicate_udf,
  std::optional<std::size_t> output_size = {},
 ...
 */
std::size_t conditional_inner_join_jit_size(
  table_view const& left,
  table_view const& right,
  std::string const& binary_predicate_udf,
  rmm::cuda_stream_view stream      = cudf::get_default_stream(),
 ...
 * @return The size that would result from performing the requested join
 */
std::size_t conditional_left_join_jit_size(
  table_view const& left,
  table_view const& right,
  std::string const& binary_predicate_udf,
  rmm::cuda_stream_view stream      = cudf::get_default_stream(),
 ...
 * @return The size that would result from performing the requested join
 */
std::size_t conditional_left_semi_join_jit_size(
  table_view const& left,
  table_view const& right,
  std::string const& binary_predicate_udf,
  rmm::cuda_stream_view stream      = cudf::get_default_stream(),
 ...
 * @return The size that would result from performing the requested join
 */
std::size_t conditional_left_anti_join_jit_size(
  table_view const& left,
  table_view const& right,
  std::string const& binary_predicate_udf,
  rmm::cuda_stream_view stream      = cudf::get_default_stream(),
