...
class data_type {
 public:
   ...
   */
  constexpr CUDA_HOST_DEVICE_CALLABLE type_id id() const noexcept { return _id; }

  /**
   * @brief Returns the scale (for fixed_point types)
   */
  constexpr CUDA_HOST_DEVICE_CALLABLE int32_t scale() const noexcept { return _fixed_point_scale; }
 ...
 */
constexpr CUDA_HOST_DEVICE_CALLABLE bool operator==(data_type const& lhs, data_type const& rhs)
{
