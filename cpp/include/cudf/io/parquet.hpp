...
class chunked_parquet_reader {
 public:
   ...
   *        nonzero `chunk_read_limit` automatically derives a `pass_read_limit` of
   *        `1.5 * chunk_read_limit`.
   *        Use an overload that accepts `pass_read_limit` to control this explicitly.
