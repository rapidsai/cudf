 ...
 * @param desired_type Target cuDF type (`STRING`, `INT8`/`INT16`/`INT32`/`INT64`, or `BOOL8`)
 * @param stream CUDA stream
 * @param mr Device memory resource
 ...
 *         is not one of the supported types (`STRING`, `INT8`/`INT16`/`INT32`/`INT64`, or `BOOL8`)
 */
 ...
 * @param desired_type Target type: `STRING`, `INT8`/`INT16`/`INT32`/`INT64`, or `BOOL8`
 * @param stream CUDA stream
 * @param mr Device memory resource
