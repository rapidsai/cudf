...
class element_hasher_with_seed {
 public:
  __device__ element_hasher_with_seed() : _seed{0}, _null_hash(std::numeric_limits<hash_value_type>::max()) {}
  __device__ element_hasher_with_seed(uint32_t seed = 0, hash_value_type null_hash = std::numeric_limits<hash_value_type>::max()) : _seed{seed}, _null_hash(null_hash) {}
