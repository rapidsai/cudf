...
typedef struct {
  ...
  gdf_size_type byte_range_offset;          //< offset of the byte range to read. 
  gdf_size_type byte_range_size;            /**< size of the byte range to read. Set to zero to read all data after byte_range_offset.
