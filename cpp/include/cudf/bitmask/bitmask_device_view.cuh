 ...
 *---------------------------------------------------------------------------**/
class mutable_bitmask_device_view {
 public:
  mutable_bitmask_device_view() = default;
  ~mutable_bitmask_device_view() = default;
  mutable_bitmask_device_view(mutable_bitmask_device_view const& other) =
      default;
  mutable_bitmask_device_view(mutable_bitmask_device_view&& other) = default;
  mutable_bitmask_device_view& operator=(
      mutable_bitmask_device_view const& other) = default;
  mutable_bitmask_device_view& operator=(mutable_bitmask_device_view&& other) =
      default;

  /**---------------------------------------------------------------------------*
   * @brief Construct a `mutable_bitmask_device_view` from a raw device memory
   *pointer and a size.
   *
 ...
 * elements and individual bits within the bitmask.
 *---------------------------------------------------------------------------**/
class bitmask_device_view {
 public:
  bitmask_device_view() = default;
  ~bitmask_device_view() = default;
  bitmask_device_view(bitmask_device_view const& other) = default;
  bitmask_device_view(bitmask_device_view&& other) = default;
  bitmask_device_view& operator=(bitmask_device_view const& other) = default;
  bitmask_device_view& operator=(bitmask_device_view&& other) = default;

  /**---------------------------------------------------------------------------*
   * @brief Construct a `bitmask_device_view` from a raw device memory pointer
   * and a size.
   *
   * Optionally accepts an `offset` (defaults to zero) to allow zero-copy
   * slicing. The `offset` indicates the bit index of the first represented bit
