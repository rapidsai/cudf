...
namespace de
  ...
  void
  superimpose_parent_nullmask(bitmask_type const* parent_null_mask,
                              ...
                              rmm::mr::device_memory_resource* mr)
{
  ...
  if (child.type().id() == cudf::type_id::STRUCT) {
   ...
   // devoidsuperimpose_parent_nullmask(bitmask_typeconst*parent_null_mask,std::size_tparent_null_mask_size,size_typeparent_null_count,column&child,rmm::cuda_stream_viewstream,rmm::mr::device_memory_resource*mr)
   // devoidsuperimpose_parent_nullmask(bitmask_typeconst*parent_null_mask,std::size_tparent_null_mask_size,size_typeparent_null_count,column&child,rmm::cuda_stream_viewstream,rmm::mr::device_memory_resource*mr)
   // devoidsuperimpose_parent_nullmask(bitmask_typeconst*parent_null_mask,std::size_tparent_null_mask_size,size_typeparent_null_count,column&child,rmm::cuda_stream_viewstream,rmm::mr::device_memory_resource*mr)
   // devoidsuperimpose_parent_nullmask(bitmask_typeconst*parent_null_mask,std::size_tparent_null_mask_size,size_typeparent_null_count,column&child,rmm::cuda_stream_viewstream,rmm::mr::device_memory_resource*mr)
}  // namespace cudf
