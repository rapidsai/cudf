...
struct operator_functor<ast_operator::ADD, false> {
  ...
  CUDF_DI auto operator()(LHS lhs, RHS rhs) -> decltype(lhs + rhs)
  {
    return lhs + rhs;
  }
};
...
struct operator_functor<ast_operator::TRUE_DIV, false> {
  ...
  template <typename LHS, typename RHS>
  CUDF_DI auto operator()(LHS lhs, RHS rhs)
...
struct operator_functor<ast_operator::POW, false> {
  ...
  template <typename LHS, typename RHS>
  CUDF_DI auto operator()(LHS lhs, RHS rhs) -> decltype(std::pow(lhs, rhs))
  {
...
struct operator_functor<ast_operator::IDENTITY, false> {
  ...
  CUDF_DI auto operator()(InputT input) -> decltype(input)
  {
    return input;
  }
};
...
struct operator_functor<ast_operator::SIN, false> {
  ...
  CUDF_DI auto operator()(InputT input) -> decltype(std::sin(input))
  {
...
struct operator_functor<ast_operator::COS, false> {
  ...
  template <typename InputT, std::enable_if_t<std::is_floating_point<InputT>::value>* = nullptr>
  CUDF_DI auto operator()(InputT input) -> decltype(std::cos(input))
  {
...
struct operator_functor<ast_operator::TAN, false> {
  ...
  template <typename InputT, std::enable_if_t<std::is_floating_point<InputT>::value>* = nullptr>
  CUDF_DI auto operator()(InputT input) -> decltype(std::tan(input))
  {
...
struct operator_functor<ast_operator::ARCSIN, false> {
  ...
  template <typename InputT, std::enable_if_t<std::is_floating_point<InputT>::value>* = nullptr>
  CUDF_DI auto operator()(InputT input) -> decltype(std::asin(input))
  {
...
struct operator_functor<ast_operator::ARCCOS, false> {
  ...
  template <typename InputT, std::enable_if_t<std::is_floating_point<InputT>::value>* = nullptr>
  CUDF_DI auto operator()(InputT input) -> decltype(std::acos(input))
  {
...
struct operator_functor<ast_operator::ARCTAN, false> {
  ...
  template <typename InputT, std::enable_if_t<std::is_floating_point<InputT>::value>* = nullptr>
  CUDF_DI auto operator()(InputT input) -> decltype(std::atan(input))
  {
...
struct operator_functor<ast_operator::SINH, false> {
  ...
  template <typename InputT, std::enable_if_t<std::is_floating_point<InputT>::value>* = nullptr>
  CUDF_DI auto operator()(InputT input) -> decltype(std::sinh(input))
  {
...
struct operator_functor<ast_operator::COSH, false> {
  ...
  template <typename InputT, std::enable_if_t<std::is_floating_point<InputT>::value>* = nullptr>
  CUDF_DI auto operator()(InputT input) -> decltype(std::cosh(input))
  {
...
struct operator_functor<ast_operator::TANH, false> {
  ...
  template <typename InputT, std::enable_if_t<std::is_floating_point<InputT>::value>* = nullptr>
  CUDF_DI auto operator()(InputT input) -> decltype(std::tanh(input))
  {
...
struct operator_functor<ast_operator::ARCSINH, false> {
  ...
  template <typename InputT, std::enable_if_t<std::is_floating_point<InputT>::value>* = nullptr>
  CUDF_DI auto operator()(InputT input) -> decltype(std::asinh(input))
  {
...
struct operator_functor<ast_operator::ARCCOSH, false> {
  ...
  template <typename InputT, std::enable_if_t<std::is_floating_point<InputT>::value>* = nullptr>
  CUDF_DI auto operator()(InputT input) -> decltype(std::acosh(input))
  {
...
struct operator_functor<ast_operator::ARCTANH, false> {
  ...
  template <typename InputT, std::enable_if_t<std::is_floating_point<InputT>::value>* = nullptr>
  CUDF_DI auto operator()(InputT input) -> decltype(std::atanh(input))
  {
...
struct operator_functor<ast_operator::EXP, false> {
  ...
  template <typename InputT>
  CUDF_DI auto operator()(InputT input) -> decltype(std::exp(input))
  {
...
struct operator_functor<ast_operator::LOG, false> {
  ...
  template <typename InputT>
  CUDF_DI auto operator()(InputT input) -> decltype(std::log(input))
  {
...
struct operator_functor<ast_operator::SQRT, false> {
  ...
  template <typename InputT>
  CUDF_DI auto operator()(InputT input) -> decltype(std::sqrt(input))
  {
...
struct operator_functor<ast_operator::CBRT, false> {
  ...
  template <typename InputT>
  CUDF_DI auto operator()(InputT input) -> decltype(std::cbrt(input))
  {
...
struct operator_functor<ast_operator::CEIL, false> {
  ...
  template <typename InputT>
  CUDF_DI auto operator()(InputT input) -> decltype(std::ceil(input))
  {
...
struct operator_functor<ast_operator::FLOOR, false> {
  ...
  template <typename InputT>
  CUDF_DI auto operator()(InputT input) -> decltype(std::floor(input))
  {
...
struct operator_functor<ast_operator::ABS, false> {
  ...
  CUDF_DI auto operator()(InputT input) -> decltype(std::abs(input))
  {
...
struct operator_functor<ast_operator::RINT, false> {
  ...
  template <typename InputT>
  CUDF_DI auto operator()(InputT input) -> decltype(std::rint(input))
  {
...
struct cast {
  ...
  CUDF_DI auto operator()(From f) -> decltype(static_cast<To>(f))
  {
...
struct operator_functor<op, true> {
  ...
  CUDF_DI auto operator()(LHS const lhs, RHS const rhs)
  ...
  CUDF_DI auto operator()(Input const input)
