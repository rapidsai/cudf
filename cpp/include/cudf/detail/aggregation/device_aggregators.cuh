...
/**
 * @brief Updates an element at the given column index in `target` table by performing aggregation
 * operations from the corresponding element in the `source` table.
 *
