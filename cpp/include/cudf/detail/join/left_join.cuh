...
struct left_join {
 public:
  ...
  using storage_type        = cuco::bucket_storage<cuco::pair<hash_value_type, rhs_index_type>, 
  ...
  using primitive_row_hasher = cudf::row::primitive::row_hasher<cudf::hashing::detail::default_hash>;
