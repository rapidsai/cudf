...
/**
 * @brief Synchronously construct a `thrust::vector` containing a copy of data from a
 * `device_span`
 *
 * @note This function does a synchronize on `stream`.
 *
...
/**
 * @brief Synchronously construct a `thrust::vector` containing a copy of data from a device
 * container
 *
 * @note This function synchronizes `stream`.
 *
