...
/**
 * @brief Export column as a DLManagedTensor or DLManagedTensorVersioned
 *
...
/**
 * @brief Export column as a DLManagedTensorVersioned
 *
 * Same as to_dlpack_unversioned, but returning versioned tensors (in the future
 * will be the only supported format).
 */
