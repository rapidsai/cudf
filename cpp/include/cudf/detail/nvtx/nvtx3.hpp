...
class message {
 public:
   ...
   *
   */
  [[nodiscard]] NVTX3_RELAXED_CONSTEXPR nvtxMessageType_t get_type() const noexcept
  {
    return type_;
  }
...
class payload {
 public:
   ...
   *
   */
  [[nodiscard]] NVTX3_RELAXED_CONSTEXPR nvtxPayloadType_t get_type() const noexcept
  {
    return type_;
  }
