 ...
 */
gdf_column allocate_like(gdf_column const& input, bool allocate_mask = true, cudaStream_t stream = 0);
 ...
 *---------------------------------------------------------------------------**/
table allocate_like(table const& t, bool allocate_mask = true, cudaStream_t stream = 0);
