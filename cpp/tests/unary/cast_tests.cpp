  ...
  switch (type_id) {
    case cudf::type_id::TIMESTAMP_DAYS:
      return {cudf::data_type{type_id},
              static_cast<cudf::size_type>(test_timestamps_D.size()),
    ...
    case cudf::type_id::TIMESTAMP_SECONDS:
      return {cudf::data_type{type_id},
              static_cast<cudf::size_type>(test_timestamps_s.size()),
    ...
    case cudf::type_id::TIMESTAMP_MILLISECONDS:
      return {cudf::data_type{type_id},
              static_cast<cudf::size_type>(test_timestamps_ms.size()),
    ...
    case cudf::type_id::TIMESTAMP_MICROSECONDS:
      return {cudf::data_type{type_id},
              static_cast<cudf::size_type>(test_timestamps_us.size()),
    ...
    case cudf::type_id::TIMESTAMP_NANOSECONDS:
      return {cudf::data_type{type_id},
              static_cast<cudf::size_type>(test_timestamps_ns.size()),
    ...
    case cudf::type_id::DURATION_DAYS:
      return {cudf::data_type{type_id},
              static_cast<cudf::size_type>(test_durations_D.size()),
    ...
    case cudf::type_id::DURATION_SECONDS:
      return {cudf::data_type{type_id},
              static_cast<cudf::size_type>(test_durations_s.size()),
    ...
    case cudf::type_id::DURATION_MILLISECONDS:
      return {cudf::data_type{type_id},
              static_cast<cudf::size_type>(test_durations_ms.size()),
    ...
    case cudf::type_id::DURATION_MICROSECONDS:
      return {cudf::data_type{type_id},
              static_cast<cudf::size_type>(test_durations_us.size()),
    ...
    case cudf::type_id::DURATION_NANOSECONDS:
      return {cudf::data_type{type_id},
              static_cast<cudf::size_type>(test_durations_ns.size()),
