...
TYPED_TEST(ColumnTypeCheckTestTyped, SameFixedWidth)
{
  ...
  EXPECT_TRUE(cudf::types_equal(lhs, rhs));
}
...
TEST_F(ColumnTypeCheckTest, SameString)
{
  ...
  EXPECT_TRUE(cudf::types_equal(lhs2, rhs2));

  cudf::test::strings_column_wrapper lhs3{}, rhs3{};
  EXPECT_TRUE(cudf::types_equal(lhs3, rhs3));
}
...
TEST_F(ColumnTypeCheckTest, SameList)
{
  ...
  EXPECT_TRUE(cudf::types_equal(lhs4, rhs4));
}
...
TEST_F(ColumnTypeCheckTest, DifferentFixedWidth)
{
  ...
  EXPECT_FALSE(cudf::types_equal(lhs5, rhs5));
  ...
  EXPECT_FALSE(cudf::types_equal(lhs6, rhs6));
}
...
{
  {
    // An empty table
    cudf::table_view tbl{};
    EXPECT_TRUE(cudf::all_types_equal(tbl.begin(), tbl.end()));
  }
...
TEST_F(ColumnTypeCheckTest, AllTypesNotEqual)
{
  ...
  EXPECT_FALSE(cudf::all_types_equal(tbl.begin(), tbl.end()));
}
