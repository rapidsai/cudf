...
using Implementations = ::testing::Types<KeyValueTypes<int, int>, KeyValueTypes<int, long long>, KeyValueTypes<int, unsigned long long>, KeyValueTypes<unsigned long long, int>, KeyValueTypes<unsigned long long, long long>, KeyValueTypes<unsigned long long, unsigned long long>>;
