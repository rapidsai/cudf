...
{
  auto const results = cudf::lists::set_union(lists_cv{lhs}, lists_cv{rhs});
...
TEST_F(SetUnionTest, TrivialTest)
{
  ...
  auto const expected       = lists_col{{lists_col{{null, 0.0, 0.5, 1.0, 5.0, NaN}, null_at(0)},
                                   lists_col{{null, 0.0, 1.0, 2.0, 5.0, NaN}, null_at(0)},
                                   lists_col{} /*NULL*/,
                                   lists_col{} /*NULL*/},
                                  nulls_at({2, 3})};
