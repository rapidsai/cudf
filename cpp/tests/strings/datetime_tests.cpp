...
TEST_F(StringsDatetimeTest, duration_s)
{
  using T = cudf::duration_s;
  cudf::test::fixed_width_column_wrapper<T> timestamps{
  ...
  auto results = cudf::strings::from_durations(timestamps, "%d days %+%H:%M:%S");
...
TEST_F(StringsDatetimeTest, duration_D)
{
