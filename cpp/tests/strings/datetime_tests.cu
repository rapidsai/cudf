...
{
    cudf::test::strings_column_wrapper strings{ "1974-02-28 01:23:45 PM", "2019-07-17 02:34:56 AM", "2019-03-20 12:34:56 PM", "2020-02-29 12:00:00 AM" };
    auto strings_view = cudf::strings_column_view(strings);
    auto results = cudf::strings::to_timestamps(strings_view, cudf::data_type{cudf::TIMESTAMP_SECONDS}, "%Y-%m-%d %I:%M:%S %p" );
    cudf::test::fixed_width_column_wrapper<cudf::timestamp_s> expected{ 131289825, 1563330896, 1553085296, 1582934400 };
    cudf::test::expect_columns_equal(*results, expected);
}
...
TEST_F(StringsDatetimeTest, ToTimestampMicrosecond)
{
    ...
    cudf::test::fixed_width_column_wrapper<cudf::timestamp_ms> expected_ms{ 131246625987, 1563330896001, 1553085296100, 1582934400555 };
    cudf::test::expect_columns_equal(*results, expected_ms);
    results = cudf::strings::to_timestamps(strings_view, cudf::data_type{cudf::TIMESTAMP_NANOSECONDS}, "%Y-%m-%d %H:%M:%S.%f" );
    cudf::test::fixed_width_column_wrapper<cudf::timestamp_ns> expected_ns{ 131246625987000000, 1563330896001234000,
...
TEST_F(StringsDatetimeTest, ToTimestampMillisecond)
{
    ...
    cudf::test::fixed_width_column_wrapper<cudf::timestamp_us> expected_us{ 1530705600123000, 1586178540555000 };
    cudf::test::expect_columns_equal(*results, expected_us);
    results = cudf::strings::to_timestamps(strings_view, cudf::data_type{cudf::TIMESTAMP_NANOSECONDS}, "%Y-%m-%d %H:%M:%S.%3f" );
    cudf::test::fixed_width_column_wrapper<cudf::timestamp_ns> expected_ns{ 1530705600123000000, 1586178540555000000 };
    cudf::test::expect_columns_equal(*results, expected_ns);
}

TEST_F(StringsDatetimeTest, ToTimestampTimezone)
{
    cudf::test::strings_column_wrapper strings{ "1974-02-28 01:23:45+0100", "2019-07-17 02:34:56-0300",
                                                "2019-03-20 12:34:56+1030", "2020-02-29 12:00:00-0500" };
    auto strings_view = cudf::strings_column_view(strings);
    auto results = cudf::strings::to_timestamps(strings_view, cudf::data_type{cudf::TIMESTAMP_SECONDS}, "%Y-%m-%d %H:%M:%S%z" );
    cudf::test::fixed_width_column_wrapper<cudf::timestamp_s> expected{ 131243025, 1563341696, 1553047496, 1582995600 };
    cudf::test::expect_columns_equal(*results, expected);
}
...
{
    cudf::test::fixed_width_column_wrapper<cudf::timestamp_s> timestamps{ 1530705600, 1582934461, 1451430122, 1318302183 };
    auto results = cudf::strings::from_timestamps(timestamps, "%Y-%m-%d %I:%M:%S %p");
    cudf::test::strings_column_wrapper expected{ "2018-07-04 12:00:00 PM", "2020-02-29 12:01:01 AM", "2015-12-29 11:02:02 PM", "2011-10-11 03:03:03 AM" };
    cudf::test::expect_columns_equal(*results, expected);
}
...
TEST_F(StringsDatetimeTest, FromTimestampTimezone)
{
    ...
    cudf::test::strings_column_wrapper expected{ "07/04/18 120000+0000", "02/29/20 000101+0000", "12/29/15 230202+0000", "10/11/11 030303+0000" };
    cudf::test::expect_columns_equal(*results, expected);
}
...
TEST_F(StringsDatetimeTest, ZeroSizeStringsColumn)
{
    ...
    results = cudf::strings::to_timestamps(cudf::strings_column_view(zero_size_strings_column),
        cudf::data_type{cudf::TIMESTAMP_SECONDS}, "%Y");
