...
class transform_mutable_iterator_proxy {
 public:
  __host__ __device__ transform_mutable_iterator_proxy(Iterator const& it,
  ...
  __thrust_exec_check_disable__ template <typename T>
  __host__ __device__ transform_mutable_iterator_proxy operator=(const T& x)
  {
    *it = reverse(x);
    return *this;
  }

  __thrust_exec_check_disable__ __host__ __device__ transform_mutable_iterator_proxy
  operator=(const transform_mutable_iterator_proxy& x)
  {
    *it = reverse(x);
    return *this;
  }
...
struct transform_mutable_iterator_base {
  typedef thrust::iterator_adaptor<
    ...
    Iterator,
    typename std::result_of<ForwardFunction(
