...
class transform_mutable_iterator : public detail::transform_mutable_iterator_base<ForwardFunction,
                                                                                  ReverseFunction,
                                                                                  Iterator>::type {
  /*! \cond
   */
 ...
 public:
  typedef typename detail::
    transform_mutable_iterator_base<ForwardFunction, ReverseFunction, Iterator>::type super_t;
   ...
   */
  __host__ __device__ transform_mutable_iterator(Iterator const& out,
 ...
 private:
  ...
  {
    return detail::transform_mutable_iterator_proxy<ForwardFunction, ReverseFunction, Iterator>(
 ...
 */
template <typename ForwardFunction, typename ReverseFunction, typename Iterator>
transform_mutable_iterator<ForwardFunction, ReverseFunction, Iterator> __host__ __device__
make_transform_mutable_iterator(Iterator out, ForwardFunction forward, ReverseFunction reverse)
{
  return transform_mutable_iterator<ForwardFunction, ReverseFunction, Iterator>(
    out, forward, reverse);
