...
TEST_F(DropDuplicate, NonNullTable)
{
    ...
    cudf::table_view expected_first {{exp_col1_first, exp_col2_first, exp_col1_key_first, exp_col2_key_first}};
    ...
    cudf::table_view expected_last {{exp_col1_last, exp_col2_last, exp_col1_key_last, exp_col2_key_last}};
    ...
    cudf::table_view expected_unique {{exp_col1_unique, exp_col2_unique, exp_col1_key_unique, exp_col2_key_unique}};
