...
TYPED_TEST(DropDuplicatesTest, SingleValue)
{
  TypedDropDuplicatesTest<TypeParam>(
    cudf::test::column_wrapper<TypeParam>{column_size,
      [](cudf::index_type row) { return 2; }, false},
    cudf::test::column_wrapper<TypeParam>{1,
      [](cudf::index_type row) { return 2; }, 
      [](cudf::index_type row) { return true; }
      });
      //[](cudf::index_type row) { return true; }});
}
...
TYPED_TEST(DropDuplicatesTest, Duplicate)
{
  TypedDropDuplicatesTest<TypeParam>(
      cudf::test::column_wrapper<TypeParam>{column_size,
      [](cudf::index_type row) { return row%100; }, false},
    ...
    )
{
  ...
  cudf::index_type* index_ptr = ((cudf::index_type*)index_col.data);

  rmm::device_vector<cudf::index_type> ordered(rows);
...
{
  cudf::test::column_wrapper<cudf::index_type> index{source_col1.size(),
      [](cudf::index_type row) { return row; },
      [](cudf::index_type row) { return true; }};
...
auto lamda_valid = [](cudf::index_type row) { return true; };
...
{
  auto lamda_type0 = [](cudf::index_type row) { return typename TypeParam::Type0(row); };
  auto lamda_type1 = [](cudf::index_type row) { return typename TypeParam::Type1(row); };
...
{
  auto lamda_type0 = [](cudf::index_type row) { return typename TypeParam::Type0(row%100); };
  auto lamda_type1 = [](cudf::index_type row) { return typename TypeParam::Type1(row%7); };
  cudf::test::column_wrapper<typename TypeParam::Type0> col1{column_size, lamda_type0};
  cudf::test::column_wrapper<typename TypeParam::Type1> col2{column_size, lamda_type1};
  TypedDropDuplicatesTest<TypeParam>(
    col1,
  ...
  TypedDropDuplicatesTest<TypeParam>(
    ...
    cudf::test::column_wrapper<typename TypeParam::Type1>{700,
      [](cudf::index_type row) { return typename TypeParam::Type1((column_size-700+row)%7); }, lamda_valid},
    cudf::duplicate_keep_option::KEEP_LAST);
