...
TYPED_TEST(CrossJoinTypeTests, CrossJoin)
{
  ...
  auto a_2 = column_wrapper<TypeParam>(
    cudf::test::make_fixed_width_column_with_type_param<TypeParam>({0, 0, 0, 0}));
  ...
  auto b_2 = column_wrapper<TypeParam>(
    cudf::test::make_fixed_width_column_with_type_param<TypeParam>({0, 0, 0}));
  ...
  auto expect_2 =
    column_wrapper<TypeParam>(cudf::test::make_fixed_width_column_with_type_param<TypeParam>(
