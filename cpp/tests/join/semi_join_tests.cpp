...
TEST_F(JoinTest, LeftSemiJoin_empty_result)
{
  ...
  CUDF_TEST_EXPECT_COLUMNS_EQUAL(join_table2->get_column(2), expect_3);
}
...
TEST_F(JoinTest, LeftSemiAntiJoin_empty_table)
{
  ...
  CUDF_TEST_EXPECT_COLUMNS_EQUAL(join_table2->get_column(3), expect_3);
  ...
  CUDF_TEST_EXPECT_COLUMNS_EQUAL(join_table3->get_column(3), expect_3);
  ...
  CUDF_TEST_EXPECT_COLUMNS_EQUAL(join_table4->get_column(3), expect_3);
  ...
  CUDF_TEST_EXPECT_COLUMNS_EQUAL(join_table5->get_column(3), expect_3);
}
