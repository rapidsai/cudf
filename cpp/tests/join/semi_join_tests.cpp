...
TEST_F(JoinTest, LeftSemiAntiJoin_exceptions) {
  ...
  //
  EXPECT_THROW(cudf::left_semi_join(table_a, table_b, {}, {}, {}),
               cudf::logic_error);

  EXPECT_THROW(cudf::left_anti_join(table_a, table_b, {}, {}, {}),
               cudf::logic_error);

  EXPECT_THROW(cudf::left_semi_join(table_b, table_a, {}, {}, {}),
               cudf::logic_error);

  EXPECT_THROW(cudf::left_anti_join(table_b, table_a, {}, {}, {}),
               cudf::logic_error);
...
TEST_F(JoinTest, LeftSemiJoin_empty_result) {
  ...
  auto join_table2 = cudf::left_semi_join(table_a, table_b,
                                          {},
                                          {},
                                          {0, 1, 3});
...
TEST_F(JoinTest, LeftAntiJoin_empty_result) {
  ...
  auto join_table2 = cudf::left_anti_join(table_a, table_b,
                                          {},
                                          {},
                                          {0, 1, 3});
...
TEST_F(JoinTest, LeftSemiAntiJoin_empty_table) {
  ...
  auto join_table2 = cudf::left_semi_join(table_b, table_a,
                                         {0, 1, 3},
                                         {0, 1, 3},
                                         {0, 1, 2, 3});
  ...
  auto join_table3 = cudf::left_anti_join(table_a, table_b,
                                         {0, 1, 3},
                                         {0, 1, 3},
                                         {0, 1, 2, 3});
  ...
  auto join_table4 = cudf::left_anti_join(table_a, table_a,
                                          {0, 1, 3},
                                          {0, 1, 3},
                                         {0, 1, 2, 3});
  ...
  auto join_table5 = cudf::left_anti_join(table_a, table_a,
                                         {0, 1, 3},
                                         {0, 1, 3},
                                         {0, 1, 2, 3});
