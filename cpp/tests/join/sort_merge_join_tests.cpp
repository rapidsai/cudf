...
struct SortMergeJoinTest : public cudf::test::BaseFixture {};

TEST_F(SortMergeJoinTest, InnerJoinNoNullsSingleColumn)
{
...
TEST_F(SortMergeJoinTest, InnerJoinNoNullsMultiColumn)
{
  column_wrapper<int32_t> col0_0{{3, 1, 2, 0, 2}};
  strcol_wrapper col0_1({"s1", "s1", "s0", "s4", "s0"});
  column_wrapper<int32_t> col0_2{{0, 1, 2, 4, 1}};
