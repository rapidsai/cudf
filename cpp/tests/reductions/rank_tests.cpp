...
TYPED_TEST(TypedRankScanTest, Rank)
{
  ...
  this->test_ungrouped_rank_scan(*col,
                                 expected_dense_vals,
                                 cudf::make_rank_aggregation(cudf::rank_method::DENSE),
                                 null_policy::INCLUDE);
  this->test_ungrouped_rank_scan(*col,
                                 expected_rank_vals,
                                 cudf::make_rank_aggregation(cudf::rank_method::MIN),
                                 null_policy::INCLUDE);
}
...
TYPED_TEST(TypedRankScanTest, NestedStructs)
{
  ...
  auto dense_out      = cudf::scan(nested_col,
                              cudf::make_rank_aggregation(cudf::rank_method::DENSE),
                              scan_type::INCLUSIVE,
                              null_policy::INCLUDE);
  auto dense_expected = cudf::scan(flat_col,
                                   cudf::make_rank_aggregation(cudf::rank_method::DENSE),
                                   scan_type::INCLUSIVE,
                                   null_policy::INCLUDE);
  auto rank_out       = cudf::scan(nested_col,
                             cudf::make_rank_aggregation(cudf::rank_method::MIN),
                             scan_type::INCLUSIVE,
                             null_policy::INCLUDE);
  auto rank_expected  = cudf::scan(flat_col,
                                  cudf::make_rank_aggregation(cudf::rank_method::MIN),
                                  scan_type::INCLUSIVE,
                                  null_policy::INCLUDE);
...
TYPED_TEST(TypedRankScanTest, structsWithNullPushdown)
{
  ...
  auto dense_null_out = cudf::scan(*struct_col,
                                   cudf::make_rank_aggregation(cudf::rank_method::DENSE),
                                   scan_type::INCLUSIVE,
                                   null_policy::INCLUDE);
  auto rank_null_out  = cudf::scan(*struct_col,
                                  cudf::make_rank_aggregation(cudf::rank_method::MIN),
                                  scan_type::INCLUSIVE,
                                  null_policy::INCLUDE);
  ...
  auto dense_out = cudf::scan(*struct_col,
                              cudf::make_rank_aggregation(cudf::rank_method::DENSE),
                              scan_type::INCLUSIVE,
                              null_policy::INCLUDE);
  auto rank_out  = cudf::scan(*struct_col,
                             cudf::make_rank_aggregation(cudf::rank_method::MIN),
                             scan_type::INCLUSIVE,
                             null_policy::INCLUDE);
...
TEST(RankScanTest, BoolRankWithNull)
{
  ...
  auto nullable_dense_out = cudf::scan(vals,
                                       ...
                                       scan_type::INCLUSIVE,
                                       null_policy::INCLUDE);
  auto nullable_rank_out  = cudf::scan(vals,
                                      cudf::make_rank_aggregation(cudf::rank_method::MIN),
                                      scan_type::INCLUSIVE,
                                      null_policy::INCLUDE);
