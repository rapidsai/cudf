...
TEST_F(GroupVarTest, SingleColumn) {
  ...
  //  { 0, 3, 6, 1, 4, 5, 9, 2, 7, 8}
  auto expect_vals = cudf::test::column_wrapper<double>({9, 131. / 12, 31. / 3}, all_valid());
...
TEST_F(GroupVarTest, MultiColumn) {
  ...
  auto expect_keys = cudf::test::column_wrapper<int32_t>{1, 2, 3};
  //  { 0, 3, 6,   1, 4, 5, 9,    2, 7, 8}
  auto expect_vals0 = cudf::test::column_wrapper<double>({9, 131. / 12, 31. / 3}, all_valid());
  //  { 0, 1, 3,   2, 4, 4, 8,    6, 6, 6}
  auto expect_vals1 = cudf::test::column_wrapper<double>({7. / 3, 19. / 3, 0}, all_valid());
