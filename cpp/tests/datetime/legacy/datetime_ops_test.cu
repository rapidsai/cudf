...
struct gdf_extract_from_datetime_test : public GdfTest {
  void SetUp()
  {
    ...
    inputMonths  = {6, 6,  12, 2, 1, 3, 4, 8, 12, 12, 12, 11, 1, 2, 6,
                   6, 12, 12, 4, 1, 3, 9, 5, 12, 4,  5,  1,  6, 1, 1};
    inputDays    = {14, 14, 31, 29, 1, 11, 20, 28, 31, 30, 31, 28, 28, 3, 19,
                 22, 14, 7,  13, 3, 25, 14, 29, 15, 9,  4,  23, 1,  7, 15};
    inputHours   = {0,  0,  23, 0,  0,  2,  12, 16, 23, 1,  23, 6, 0,  18, 21,
                  17, 14, 2,  20, 16, 14, 23, 6,  1,  16, 15, 0, 21, 22, 0};
    inputMinutes = {19, 19, 59, 0,  0, 22, 30, 49, 59, 1,  59, 44, 9,  51, 8,
                    39, 47, 47, 59, 8, 59, 8,  12, 8,  43, 45, 58, 18, 24, 32};
    inputSeconds = {50, 59, 59, 1,  0,  22, 30, 1,  55, 1,  54, 8,  21, 45, 44,
                    35, 20, 40, 24, 14, 51, 14, 29, 27, 58, 35, 24, 32, 53, 48};
