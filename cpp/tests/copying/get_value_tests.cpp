...
TYPED_TEST(FixedWidthGetValueTest, BasicGet)
{
  fixed_width_column_wrapper<TypeParam> col(
    cudf::test::make_fixed_width_column_with_type_param<TypeParam>({9, 8, 7, 6}));
...
{
  fixed_width_column_wrapper<TypeParam> col(
    cudf::test::make_fixed_width_column_with_type_param<TypeParam>({9, 8, 7, 6}, {0, 1, 0, 1}));
...
{
  fixed_width_column_wrapper<TypeParam> keys(
    cudf::test::make_fixed_width_column_with_type_param<TypeParam>({6, 7, 8, 9}));
