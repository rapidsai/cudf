...
struct GroupedRollingRangeOrderByNumericTest : public BaseGroupedRollingRangeOrderByTest<T> {
  ...
  using base::num_rows;
  using base::get_grouped_range_rolling_result;
  ...
  void run_test_no_null_oby() const
  {
    ...
    auto const results =
      get_grouped_range_rolling_result(preceding, following, *order_by);
  ...
  void run_test_nulls_in_oby() const
  {
    ...
    auto const results =
        get_grouped_range_rolling_result(preceding, following, *nulled_order_by);
...
struct GroupedRollingRangeOrderByDecimalTypedTest : BaseGroupedRollingRangeOrderByTest<typename DecimalT::rep> {
                                              ...
                                              numeric::scale_type const& range_scale) const
  {
    ...
    return base::get_grouped_range_rolling_result(preceding, following, order_by_column);
  }
