...
TEST(GroupedRollingRangeMultiOrderByTest, CurrentRowPeerFrameSupportsMultipleRequests)
{
  ...
  requests.push_back({values->view(), 1, cudf::make_min_aggregation<cudf::rolling_aggregation>()});
