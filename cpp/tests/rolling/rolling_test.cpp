...
struct RollingTestNumba : public cudf::test::BaseFixture {
...
TEST_F(RollingTestNumba, NumbaGenericStaticWindow)
{
  size_type size = 12;
  ...
  EXPECT_NO_THROW(output = cudf::experimental::rolling_window(input, 2, 2, 4, this->ptx, 
...
TEST_F(RollingTestNumba, NumbaGenericDynamicWindow)
{
  size_type size = 12;
  ...
  EXPECT_NO_THROW(output = cudf::experimental::rolling_window(input, preceding, following, 2,
                                                              this->ptx, rolling_operator::NUMBA_UDF,
                                                              cudf::data_type{cudf::INT64}));
