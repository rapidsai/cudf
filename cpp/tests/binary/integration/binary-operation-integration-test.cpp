...
TEST_F(BinaryOperationIntegrationTest, Add_Scalar_Vector_SI32_FP32_UI32) {
    ...
    auto result = gdf_binary_operation_s_v(out.column(), vax.scalar(), vay.column(), GDF_ADD);
...
TEST_F(BinaryOperationIntegrationTest, Sub_Scalar_Vector_SI32_FP32_UI32) {
    ...
    auto result = gdf_binary_operation_s_v(out.column(), vax.scalar(), vay.column(), GDF_SUB);
    ASSERT_TRUE(result == GDF_SUCCESS);
...
TEST_F(BinaryOperationIntegrationTest, Sub_Vector_Vector_UI64) {
    ...
    auto result = gdf_binary_operation_v_v(out.column(), vax.column(), vay.column(), GDF_SUB);
    ASSERT_TRUE(result == GDF_SUCCESS);
...
TEST_F(BinaryOperationIntegrationTest, Mul_Vector_Vector_UI64) {
    ...
    auto result = gdf_binary_operation_v_v(out.column(), vax.column(), vay.column(), GDF_MUL);
    ASSERT_TRUE(result == GDF_SUCCESS);
...
TEST_F(BinaryOperationIntegrationTest, Div_Vector_Vector_UI64) {
    ...
    auto result = gdf_binary_operation_v_v(out.column(), vax.column(), vay.column(), GDF_DIV);
    ASSERT_TRUE(result == GDF_SUCCESS);
...
TEST_F(BinaryOperationIntegrationTest, TrueDiv_Vector_Vector_UI64) {
    ...
    auto result = gdf_binary_operation_v_v(out.column(), vax.column(), vay.column(), GDF_TRUE_DIV);
    ASSERT_TRUE(result == GDF_SUCCESS);
...
TEST_F(BinaryOperationIntegrationTest, FloorDiv_Vector_Vector_UI64) {
    ...
    auto result = gdf_binary_operation_v_v(out.column(), vax.column(), vay.column(), GDF_FLOOR_DIV);
    ASSERT_TRUE(result == GDF_SUCCESS);
...
TEST_F(BinaryOperationIntegrationTest, Mod_Vector_Vector_UI64) {
    ...
    auto result = gdf_binary_operation_v_v(out.column(), vax.column(), vay.column(), GDF_MOD);
    ASSERT_TRUE(result == GDF_SUCCESS);
...
TEST_F(BinaryOperationIntegrationTest, Pow_Vector_Vector_UI64) {
    ...
    auto result = gdf_binary_operation_v_v(out.column(), vax.column(), vay.column(), GDF_POW);
    ASSERT_TRUE(result == GDF_SUCCESS);
