...
TEST_F(BinaryOperationIntegrationTest, And_Vector_Vector_SI64) {
    using AND = cudf::library::operation::BitwiseAnd<int64_t, int64_t, int64_t>;
...
TEST_F(BinaryOperationIntegrationTest, Or_Vector_Vector_SI64) {
    using OR = cudf::library::operation::BitwiseOr<int64_t, int64_t, int64_t>;
...
TEST_F(BinaryOperationIntegrationTest, Xor_Vector_Vector_SI64) {
    using XOR = cudf::library::operation::BitwiseXor<int64_t, int64_t, int64_t>;
