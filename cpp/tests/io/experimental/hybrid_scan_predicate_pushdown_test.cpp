...
struct HybridScanPredicatePushdownTest : public cudf::test::BaseFixture {};

TEST_F(HybridScanPredicatePushdownTest, FilterRowGroupsWithStats)
{
  srand(0xc001);
  using T = uint32_t;
...
template <typename T>
struct PageFilteringWithPageIndexStats : public HybridScanPredicatePushdownTest {};
...
TEST_F(HybridScanPredicatePushdownTest, FilterRowGroupsWithDictBasic)
{
  srand(0xcafe);
  using T = uint32_t;
...
template <typename T>
struct RowGroupFilteringWithDictTest : public HybridScanPredicatePushdownTest {};
