...
{
  std::vector<std::string> names{"header1", "header,2", "quote\"embedded", "\"quoted\""};
  ...
  cudf::table_view input_table(
    std::vector<cudf::column_view>{int_column, string_column, int_column, int_column});
  ...
  cudf_io::csv_reader_options in_opts =
    cudf_io::csv_reader_options::builder(cudf_io::source_info{filepath})
      .names(names)
      .dtypes(std::vector<std::string>{"int32", "str", "int32", "int32"});
  auto result = cudf_io::read_csv(in_opts);
