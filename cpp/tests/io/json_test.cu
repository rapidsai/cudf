...
TEST_F(JsonReaderTest, MultiColumn) {
  ...
  cudf::test::expect_columns_equal(view.column(0), int8_wrapper{int8_values.begin(), int8_values.end(), validity});
  cudf::test::expect_columns_equal(view.column(1), int16_wrapper{int16_values.begin(), int16_values.end(), validity});
  cudf::test::expect_columns_equal(view.column(2), int16_wrapper{int16_values.begin(), int16_values.end(), validity});
  cudf::test::expect_columns_equal(view.column(3), int_wrapper{int32_values.begin(), int32_values.end(), validity});
