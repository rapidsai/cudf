...
TEST_F(CsvTest, IgnoreQuotes) {
...

  {
    ...
    checkStrColumn(df.get_column(1),
...
TEST_F(CsvTest, Booleans) {
...

  {
    ...
    EXPECT_THAT(fourthCol.hostdata(),
                ::testing::ElementsAre(
                  cudf::true_v, cudf::true_v, cudf::false_v, cudf::true_v, cudf::false_v));
  }
}
...
TEST_F(CsvTest, Dates) {
...

  {
    ...
    EXPECT_THAT(ACol.hostdata(),
                ::testing::ElementsAre(983750400000,
                                       1288483200000,
                                       782611200000,
                                       656208000000,
                                       0,
...
TEST_F(CsvTest, Timestamps) {
...

  {
    ...
    auto ACol = gdf_host_column<uint64_t>(df.get_column(0));
    EXPECT_THAT(ACol.hostdata(),
                ::testing::ElementsAre(1288508400000,
                                       988873200000,
                                       782636400000,
                                       656233200000,
                                       28800000,
...
TEST_F(gdf_csv_test, TimestampSeconds) {
...

  {
    ...
    EXPECT_THAT(ACol.hostdata(),
                ::testing::ElementsAre(
                  1288508400, 988873200, 782636400, 656233200, 28800, 1462003323, 1391279423));
  }
}
...
TEST_F(gdf_csv_test, TimestampMicroseconds) {
...

  {
    ...
    auto ACol = gdf_host_column<uint64_t>(df.get_column(0));
    EXPECT_THAT(ACol.hostdata(),
                ::testing::ElementsAre(1288508400000000,
                                       988873200000000,
                                       782636400000000,
                                       656233200000000,
                                       28800000000,
...
TEST_F(gdf_csv_test, TimestampNanoseconds) {
...

  {
    ...
    auto ACol = gdf_host_column<uint64_t>(df.get_column(0));
    EXPECT_THAT(ACol.hostdata(),
                ::testing::ElementsAre(1288508400000000000,
                                       988873200000000000,
                                       782636400000000000,
                                       656233200000000000,
                                       28800000000000,
...
TEST_F(gdf_csv_test, DatesCastToTimestampMicroseconds) {
...

  {
    ...
    auto ACol = gdf_host_column<uint64_t>(df.get_column(0));
    EXPECT_THAT(ACol.hostdata(),
                ::testing::ElementsAre(983750400000000,
                                       1288483200000000,
                                       782611200000000,
                                       656208000000000,
                                       0,
...
TEST_F(gdf_csv_test, DatesCastToTimestampNanoseconds) {
...

  {
    ...
    auto ACol = gdf_host_column<uint64_t>(df.get_column(0));
    EXPECT_THAT(ACol.hostdata(),
                ::testing::ElementsAre(983750400000000000,
                                       1288483200000000000,
                                       782611200000000000,
                                       656208000000000000,
                                       0,
...
TEST_F(CsvTest, Writer) {
  ...
  std::string verify =
    "\"boolean\",\"integer\",\"long\",\"short\",\"byte\",\"float\",\"double\",\"string\","
    "\"datetime\"\n"
