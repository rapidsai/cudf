...
TEST_F(TypeInference, Basic)
{
  ...
  auto const d_string_offset = cudf::detail::make_device_uvector_async(
    string_offset, cudf::get_default_stream(), cudf::get_current_device_resource_ref_unsafe());
  auto const d_string_length = cudf::detail::make_device_uvector_async(
    string_length, cudf::get_default_stream(), cudf::get_current_device_resource_ref_unsafe());
