...
TEST_F(VariantExtractTest, ApacheObjectPrimitiveExtractString)
{
  ...
  auto got = cudf::extract_variant_field(struc,
                                         "string_field",
...
TEST_F(VariantExtractTest, ApacheNestedGetVariantField)
{
  ...
  auto name_str = cudf::cast_variant(name->view(), cudf::data_type{cudf::type_id::STRING}, stream);
