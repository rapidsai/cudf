...
TYPED_TEST(IsSortedAlphaNum, AlphaNumericalTrue) {
  ...
  column_wrapper<int32_t> col3 =
    column_wrapper<int32_t>({1, 1, 1, 1}, [](auto row) { return true; });
  column_wrapper<int32_t> col4 =
    column_wrapper<int32_t>({4, 3, 2, 1}, [](auto row) { return true; });
...
TYPED_TEST(IsSorted, NumericalNullSmallest) {
  ...
  column_wrapper<T> col1 = column_wrapper<T>({1, 1, 1, 1}, [](auto row) { return true; });
  column_wrapper<T> col2 =
    column_wrapper<T>({4, 2, 3, 4}, [](auto row) { return ((row == 0) ? false : true); });
...
TYPED_TEST(IsSorted, NumericalNullBiggest) {
  ...
  column_wrapper<T> col1 = column_wrapper<T>({1, 1, 1, 1}, [](auto row) { return true; });
  column_wrapper<T> col2 =
    column_wrapper<T>({1, 2, 3, 1}, [](auto row) { return ((row == 3) ? false : true); });
