...
TYPED_TEST(groupby_quantile_test, basic) {
  ...
  auto agg =
    cudf::experimental::make_quantile_aggregation({0.5}, experimental::interpolation::LINEAR);
...
TYPED_TEST(groupby_quantile_test, interpolation_types) {
  ...
  auto agg1 =
    cudf::experimental::make_quantile_aggregation({0.4}, experimental::interpolation::LINEAR);
  ...
  auto agg2 =
    cudf::experimental::make_quantile_aggregation({0.4}, experimental::interpolation::NEAREST);
  ...
  auto agg3 =
    cudf::experimental::make_quantile_aggregation({0.4}, experimental::interpolation::LOWER);
  ...
  auto agg4 =
    cudf::experimental::make_quantile_aggregation({0.4}, experimental::interpolation::HIGHER);
  ...
  auto agg5 =
    cudf::experimental::make_quantile_aggregation({0.4}, experimental::interpolation::MIDPOINT);
