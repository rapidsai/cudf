...
inline std::pair<table, table> sort_by_key(cudf::table const& keys,
  ...
  cudf::table sorted_output_keys = cudf::allocate_like(keys, mask_allocation_policy::RETAIN);
  cudf::table sorted_output_values = cudf::allocate_like(values, mask_allocation_policy::RETAIN);
