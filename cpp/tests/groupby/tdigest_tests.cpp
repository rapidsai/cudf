...
TEST_F(TDigestMergeTest, AllValuesAreNull)
{
  ...
  auto const expected_computed_vals = cudf::tdigest::detail::make_empty_tdigests_column(
  ...
  auto const expected_merged_vals = cudf::tdigest::detail::make_empty_tdigests_column(
