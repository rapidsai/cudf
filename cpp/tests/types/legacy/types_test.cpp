...
struct WrappersTest : public ::testing::Test {
  ...
  UnderlyingType rand() { return dist(rng); }
};
...
struct Bool8CtorTest : public ::testing::Test {
  ...
  using uniform_distribution =
    typename std::conditional_t<std::is_same<SourceType, bool>::value,
  ...
  SourceType rand() { return dist(rng); }
};
...
using WrappersNoBool =
  ::testing::Types<cudf::category, cudf::timestamp, cudf::date32, cudf::date64>;

using Wrappers =
  ::testing::Types<cudf::category, cudf::timestamp, cudf::date32, cudf::date64, cudf::bool8>;
