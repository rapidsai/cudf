                  ...
                  ValueComparator const& value_comparator = ValueComparator())
{
  ...
  for (size_t i = 0; i < out_data.size(); ++i) {
    ASSERT_TRUE(value_comparator(out_data[i], (TypeOut)(op(lhs_h, rhs_data[i]))));
  }
                  ...
                  ValueComparator const& value_comparator = ValueComparator())
{
  ...
  for (size_t i = 0; i < out_data.size(); ++i) {
    ASSERT_TRUE(value_comparator(out_data[i], (TypeOut)(op(lhs_data[i], rhs_h))));
  }
                  ...
                  ValueComparator const& value_comparator = ValueComparator())
{
  ...
  ASSERT_EQ(out_data.size(), rhs_data.size());
  for (size_t i = 0; i < out_data.size(); ++i) {
    ASSERT_TRUE(value_comparator(out_data[i], (TypeOut)(op(lhs_data[i], rhs_data[i]))));
  }
