...
TEST_F(BinaryOperationIntegrationTest, Sub_Scalar_Vector_SI32_FP32_FP32)
{
  ...
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::SUB, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, Mul_Vector_Vector_SI64)
{
  ...
  auto rhs = make_random_wrapped_column<TypeRhs>(100);
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::MUL, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, Div_Vector_Vector_SI64)
{
  ...
  auto rhs = make_random_wrapped_column<TypeRhs>(100);
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::DIV, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, TrueDiv_Vector_Vector_SI64)
{
  ...
  auto rhs = make_random_wrapped_column<TypeRhs>(100);
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::TRUE_DIV, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, FloorDiv_Vector_Vector_SI64)
{
  ...
  auto rhs = make_random_wrapped_column<TypeRhs>(100);
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::FLOOR_DIV, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, Mod_Vector_Vector_SI64)
{
  ...
  auto rhs = make_random_wrapped_column<TypeRhs>(100);
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::MOD, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, Pow_Vector_Vector_FP64_SI64_SI64)
{
  ...
  auto rhs = make_random_wrapped_column<TypeRhs>(100);
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::POW, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, And_Vector_Vector_SI16_SI64_SI32)
{
  ...
  auto out = cudf::binary_operation(
    lhs, rhs, cudf::binary_op::BITWISE_AND, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, Or_Vector_Vector_SI64_SI16_SI32)
{
  ...
  auto rhs = make_random_wrapped_column<TypeRhs>(100);
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::BITWISE_OR, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, Xor_Vector_Vector_SI32_SI16_SI64)
{
  ...
  auto rhs = make_random_wrapped_column<TypeRhs>(100);
  auto out = cudf::binary_operation(
    lhs, rhs, cudf::binary_op::BITWISE_XOR, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, Logical_And_Vector_Vector_SI16_FP64_SI8)
{
  ...
  auto rhs = make_random_wrapped_column<TypeRhs>(100);
  auto out = cudf::binary_operation(
    lhs, rhs, cudf::binary_op::LOGICAL_AND, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, Logical_Or_Vector_Vector_B8_SI16_SI64)
{
  ...
  auto rhs = make_random_wrapped_column<TypeRhs>(100);
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::LOGICAL_OR, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, Less_Scalar_Vector_B8_TSS_TSS)
{
  ...
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::LESS, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, Greater_Scalar_Vector_B8_TSMS_TSS)
{
  ...
  auto rhs = make_random_wrapped_column<TypeRhs>(100);
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::GREATER, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, Equal_Vector_Vector_B8_STR_STR)
{
  ...
  auto rhs = cudf::test::strings_column_wrapper({"ééé", "bbb", "aa", "", "<null>", "bb", "eee"});
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::EQUAL, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, LessEqual_Vector_Vector_B8_STR_STR)
{
  ...
  auto rhs = cudf::test::strings_column_wrapper({"ééé", "bbb", "aa", "", "<null>", "bb", "eee"});
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::LESS_EQUAL, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, GreaterEqual_Vector_Vector_B8_STR_STR)
{
  ...
  auto rhs = cudf::test::strings_column_wrapper({"ééé", "bbb", "aa", "", "<null>", "bb", "eee"});
  auto out = cudf::binary_operation(
    lhs, rhs, cudf::binary_op::GREATER_EQUAL, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, ShiftLeft_Vector_Vector_SI32)
{
  ...
  auto rhs = make_random_wrapped_column<TypeRhs>(100);
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::SHIFT_LEFT, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, ShiftRight_Vector_Vector_SI32)
{
  ...
  auto rhs = make_random_wrapped_column<TypeRhs>(100);
  auto out = cudf::binary_operation(
    lhs, rhs, cudf::binary_op::SHIFT_RIGHT, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, ShiftRightUnsigned_Vector_Vector_SI32)
{
  ...
  auto out = cudf::binary_operation(
    lhs_w, shift_w, cudf::binary_op::SHIFT_RIGHT_UNSIGNED, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, ShiftRightUnsigned_Vector_Vector_SI32_SI16_SI64)
{
  ...
  auto rhs = make_random_wrapped_column<TypeRhs>(100);
  auto out = cudf::binary_operation(
    lhs, rhs, cudf::binary_op::SHIFT_RIGHT_UNSIGNED, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, LogBase_Vector_Scalar_SI32_SI32_float)
{
  ...
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::LOG_BASE, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, NullAwareEqual_Vector_Scalar_B8_SI32_SI32)
{
  ...
  auto op_col = cudf::binary_operation(
    int_col, int_scalar, cudf::binary_op::NULL_EQUALS, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, NullAwareEqual_Scalar_Vector_B8_tsD_tsD)
{
  ...
  auto op_col = cudf::binary_operation(
    ts_scalar, ts_col, cudf::binary_op::NULL_EQUALS, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, NullAwareEqual_Vector_Scalar_B8_string_string_EmptyString)
{
  ...
  auto op_col = cudf::binary_operation(
    str_col, str_scalar, cudf::binary_op::NULL_EQUALS, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, NullAwareEqual_Scalar_Vector_B8_string_string_ValidString)
{
  ...
  auto op_col = cudf::binary_operation(
    str_scalar, str_col, cudf::binary_op::NULL_EQUALS, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, NullAwareEqual_Vector_Vector_B8_tsD_tsD_NonNullable)
{
  ...
  auto op_col = cudf::binary_operation(
    lhs_col, rhs_col, cudf::binary_op::NULL_EQUALS, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, NullAwareMin_Vector_Scalar_SI64_SI32_SI8)
{
  ...
  auto op_col = cudf::binary_operation(
    int_col, int_scalar, cudf::binary_op::NULL_MIN, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, NullAwareMax_Scalar_Vector_FP64_SI32_SI64)
{
  ...
  auto op_col = cudf::binary_operation(
    int_scalar, int_col, cudf::binary_op::NULL_MAX, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, NullAwareMin_Vector_Scalar_SI64_SI32_FP32)
{
  ...
  auto op_col = cudf::binary_operation(
    int_col, float_scalar, cudf::binary_op::NULL_MIN, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, NullAwareMax_Scalar_Vector_SI8_SI8_FP32)
{
  ...
  auto op_col = cudf::binary_operation(
    float_scalar, int_col, cudf::binary_op::NULL_MAX, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, NullAwareMin_Vector_Vector_SI64_SI32_SI8)
{
  ...
  auto op_col = cudf::binary_operation(
    int_col, another_int_col, cudf::binary_op::NULL_MIN, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, NullAwareMax_Vector_Vector_SI64_SI32_SI8)
{
  ...
  auto op_col = cudf::binary_operation(
    int_col, another_int_col, cudf::binary_op::NULL_MAX, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, NullAwareMin_Vector_Vector_tsD_tsD_tsD)
{
  ...
  auto op_col = cudf::binary_operation(
    lhs_col, rhs_col, cudf::binary_op::NULL_MIN, data_type(type_to_id<cudf::timestamp_D>()));
...
TEST_F(BinaryOperationIntegrationTest, NullAwareMax_Vector_Vector_string_string_string_Mix)
{
  ...
  auto op_col =
    cudf::binary_operation(lhs_col, rhs_col, cudf::binary_op::NULL_MAX, data_type{type_id::STRING});
...
TEST_F(BinaryOperationIntegrationTest, NullAwareMin_Vector_Scalar_string_string_string_Mix)
{
  ...
  auto op_col = cudf::binary_operation(
    lhs_col, str_scalar, cudf::binary_op::NULL_MIN, data_type{type_id::STRING});
...
TEST_F(BinaryOperationIntegrationTest, NullAwareMax_Scalar_Vector_string_string_string_Mix)
{
  ...
  // Returns the lhs_col
  auto op_col = cudf::binary_operation(
    str_scalar, lhs_col, cudf::binary_op::NULL_MAX, data_type{type_id::STRING});
...
TEST_F(BinaryOperationIntegrationTest, PMod_Scalar_Vector_FP32)
{
  ...
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::PMOD, data_type(type_to_id<TypeOut>()));
...
TEST_F(BinaryOperationIntegrationTest, ATan2_Scalar_Vector_FP32)
{
  ...
  auto out =
    cudf::binary_operation(lhs, rhs, cudf::binary_op::ATAN2, data_type(type_to_id<TypeOut>()));
...
TYPED_TEST(FixedPointTestBothReps, FixedPointBinaryOpAdd)
{
  ...
  auto const result = cudf::binary_operation(lhs, rhs, cudf::binary_op::ADD, {});
...
TYPED_TEST(FixedPointTestBothReps, FixedPointBinaryOpMultiply)
{
  ...
  auto const result = cudf::binary_operation(lhs, rhs, cudf::binary_op::MUL, {});
...
TYPED_TEST(FixedPointTestBothReps, FixedPointBinaryOpDiv)
{
  ...
  auto const result = cudf::binary_operation(lhs, rhs, cudf::binary_op::DIV, {});
...
TYPED_TEST(FixedPointTestBothReps, FixedPointBinaryOpEqualSimple)
{
  ...
  auto const result = cudf::binary_operation(col1, col2, binary_op::EQUAL, {});
...
TYPED_TEST(FixedPointTestBothReps, FixedPointBinaryOpEqualLessGreater)
{
  ...
  auto const iota_3_after_add = cudf::binary_operation(zeros_3, iota_3, binary_op::ADD, {});
  ...
  auto const equal_result =
    cudf::binary_operation(iota_3, iota_3_after_add->view(), binary_op::EQUAL, {});
  CUDF_TEST_EXPECT_COLUMNS_EQUAL(true_col, equal_result->view());

  auto const less_result =
    cudf::binary_operation(zeros_3, iota_3_after_add->view(), binary_op::LESS, {});
  CUDF_TEST_EXPECT_COLUMNS_EQUAL(true_col, less_result->view());

  auto const greater_result =
    cudf::binary_operation(iota_3_after_add->view(), zeros_3, binary_op::GREATER, {});
