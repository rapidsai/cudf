...
//   auto rhs = make_random_wrapped_column<TypeRhs>(100);
//   auto out =
//     cudf::binary_operation(lhs, rhs, cudf::binary_operator::SUB,
//     data_type(type_to_id<TypeOut>()));
...
//   auto rhs = make_random_wrapped_column<TypeRhs>(100);
//   auto out =
//     cudf::binary_operation(lhs, rhs, cudf::binary_operator::MUL,
//     data_type(type_to_id<TypeOut>()));
...
//   auto rhs = make_random_wrapped_column<TypeRhs>(100);
//   auto out =
//     cudf::binary_operation(lhs, rhs, cudf::binary_operator::DIV,
//     data_type(type_to_id<TypeOut>()));
...
//   auto rhs = make_random_wrapped_column<TypeRhs>(100);
//   auto out =
//     cudf::binary_operation(lhs, rhs, cudf::binary_operator::MOD,
//     data_type(type_to_id<TypeOut>()));
...
//   auto rhs = make_random_wrapped_column<TypeRhs>(100);
//   auto out =
//     cudf::binary_operation(lhs, rhs, cudf::binary_operator::POW,
//     data_type(type_to_id<TypeOut>()));
...
//   auto rhs = make_random_wrapped_column<TypeRhs>(10);
//   auto out =
//     cudf::binary_operation(lhs, rhs, cudf::binary_operator::LESS,
//     data_type(type_to_id<TypeOut>()));
...
//   auto out = cudf::binary_operation(
//     lhs_w, shift_w, cudf::binary_operator::SHIFT_RIGHT_UNSIGNED,
//     data_type(type_to_id<TypeOut>()));
...
//   auto str_col = cudf::test::strings_column_wrapper({"eee", "bb", "<null>", "", "aa", "bbb",
//   "ééé"},
...
// NullAwareEqual_Scalar_Vector_B8_string_string_MatchInvalid)
// {
//   using TypeOut = bool;
...
// TEST_F(BinaryOperationIntegrationTest,
// NullAwareEqual_Vector_Vector_B8_string_string_ValidInvalid)
// {
//   using TypeOut = bool;
...
// TEST_F(BinaryOperationIntegrationTest,
// NullAwareEqual_Vector_Vector_B8_string_string_InvalidInvalid)
// {
//   using TypeOut = bool;
...
//   // Every row has a value
//   CUDF_TEST_EXPECT_COLUMNS_EQUAL(
//     *op_col, fixed_width_column_wrapper<TypeOut>{{77, -37, 0, 77}, {true, true, true, true}},
//     true);
// }
...
//   auto op_col = cudf::binary_operation(
//     lhs_col, rhs_col, cudf::binary_operator::NULL_MIN,
...
//   auto out =
//     cudf::binary_operation(lhs, rhs, cudf::binary_operator::PMOD,
//     data_type(type_to_id<TypeOut>()));
...
//   }); auto const vec1 = std::vector<RepType>(begin, begin + sz); auto const vec2 =
//   std::vector<RepType>(sz, 0);
...
//   auto const trues    = std::vector<bool>(4, true);
//   auto const col1     = fp_wrapper<RepType>{{40, 30, 20, 10, 0}, {1, 0, 1, 1, 0},
//   scale_type{-2}}; auto const col2     = fp_wrapper<RepType>{{10, 20, 30, 40, 0}, {1, 1, 1, 0,
//   0}, scale_type{-2}}; auto const expected = fp_wrapper<RepType>{{40, 20, 30, 10, 0}, {1, 1, 1,
//   1, 0}, scale_type{-2}};
...
//   auto const trues    = std::vector<bool>(4, true);
//   auto const col1     = fp_wrapper<RepType>{{40, 30, 20, 10, 0}, {1, 1, 1, 0, 0},
//   scale_type{-1}}; auto const col2     = fp_wrapper<RepType>{{10, 20, 30, 40, 0}, {1, 0, 1, 1,
//   0}, scale_type{-1}}; auto const expected = fp_wrapper<RepType>{{10, 30, 20, 40, 0}, {1, 1, 1,
//   1, 0}, scale_type{-1}};
...
//   auto const rhs = fp_wrapper<RepType>{{100, 200, 300, 500, 600, 800, 1200, 1300},
//   scale_type{-2}};
