...
def category_ranges(category: str) -> list[tuple[int, int]]:
    """Compress one Unicode general category into inclusive ranges."""
    ranges: list[tuple[int, int]] = []
    begin: int | None = None
 ...
 * Unicode character database shipped with Python.
...
"""
    ...
    output += "\n"
    output += render_array("unicode_math_symbol_ranges", category_ranges("Sm"))
