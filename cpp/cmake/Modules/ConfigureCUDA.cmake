...
if(CMAKE_BUILD_TYPE MATCHES Debug)
  ...
  set(CUDF_ENABLE_DEBUG_SYMBOL ON)
endif()

if(CUDF_ENABLE_DEBUG_SYMBOL)
  if(CMAKE_COMPILER_IS_GNUCXX)
    message(VERBOSE "CUDF: Building with -rdynamic flag")
    list(APPEND CUDF_CUDA_FLAGS -Xcompiler=-rdynamic)
    list(APPEND CUDF_CXX_FLAGS -rdynamic)
  else()
    message(VERBOSE "CUDF: Option -rdynamic is not supported without GCC compiler")
  endif()
endif()
