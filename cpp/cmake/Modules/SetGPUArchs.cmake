...
if(CUDF_BUILD_FOR_ALL_ARCHS)
  ...
  message(STATUS "CUDF: Building for all supported GPU architectures: ${CMAKE_CUDA_ARCHITECTURES}")
elseif(CUDF_BUILD_FOR_DETECTED_ARCHS)
  ...
  message(STATUS "CUDF: Building for detected GPU architectures: ${CMAKE_CUDA_ARCHITECTURES}")
endif()
...
message(STATUS "CUDF: CMAKE_CUDA_ARCHITECTURES: ${CMAKE_CUDA_ARCHITECTURES}")
