  ...
  foreach(ARG_FILE ${ARG_FILES})
    ...
    add_custom_command(
      ...
      COMMAND
        ...
        -remove-unused-globals -DJITIFY_LINK_NVRTC_STATIC=1 -D__CUDACC_RTC__ -arch=sm_60
        --device-int128 -I${CUDF_SOURCE_DIR}/include -I${CUDF_SOURCE_DIR}/src ${libcudacxx_includes}
