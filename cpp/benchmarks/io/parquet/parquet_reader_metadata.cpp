...
// Benchmark for measuring column selection time in chunked_parquet_reader constructor
...
NVBENCH_BENCH(BM_parquet_read_footer)
  ...
  .set_min_samples(4)
  .add_string_axis("io_type", {"FILEPATH", "HOST_BUFFER"})
  .add_int64_axis("num_cols", {32, 128, 512, 2048})
  .add_int64_axis("num_row_groups", {10, 100, 500});
