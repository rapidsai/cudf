...
#define ORC_WR_BENCHMARK_DEFINE(name, type_or_group)  \
...
ORC_WR_BENCHMARK_DEFINE(integral_signed, type_group_id::INTEGRAL_SIGNED);
ORC_WR_BENCHMARK_DEFINE(floats, type_group_id::FLOATING_POINT);
ORC_WR_BENCHMARK_DEFINE(timestamps, type_group_id::TIMESTAMP);
ORC_WR_BENCHMARK_DEFINE(string, cudf::type_id::STRING);
