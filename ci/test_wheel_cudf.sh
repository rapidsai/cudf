...
CUDF_WHEELHOUSE=$(RAPIDS_PY_WHEEL_NAME="cudf_${RAPIDS_PY_CUDA_SUFFIX}" rapids-download-wheels-from-s3 python)
...
rapids-pip-retry install \
  ...
  "$(echo ${PYTHON_WHEELHOUSE}/pylibcudf_"${RAPIDS_PY_CUDA_SUFFIX}"*.whl)[test]"
