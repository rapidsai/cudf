...
export LIBCUDF_FILE=`conda build --old-build-string --croot ${WORKSPACE}/.conda-bld conda/recipes/libcudf --output`
export LIBCUDF_KAFKA_FILE=`conda build --old-build-string --croot ${WORKSPACE}/.conda-bld conda/recipes/libcudf_kafka --output`
