...
python python/cudf/cudf/pandas/scripts/merge-json-files.py -d python/cudf/cudf/pandas/scripts/ -o python/cudf/cudf/pandas/scripts/pr-results.json
ls -al
cat python/cudf/cudf/pandas/scripts/pr-results.json
