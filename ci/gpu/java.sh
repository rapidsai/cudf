...
gpuci_mamba_retry remove "arrow-cpp" "pyarrow" "orc" 'arrow-cpp-proc=*=cuda'
gpuci_mamba_retry install -y "arrow-cpp=6.0.1" "pyarrow=6.0.1" 'arrow-cpp-proc=*=cuda' "pyorc" "orc" "python-confluent-kafka=1.7.0"
