...
gpuci_conda_retry remove --force pandas numpy
gpuci_mamba_retry install -c conda-forge -y "pandas=1.4.2" "numpy<=1.21" --force-reinstall
#pip install -I pandas==1.4.2
