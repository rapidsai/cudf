...
CUDF_POLARS__STREAMING__TARGET_PARTITION_SIZE=805306368 CUDF_POLARS__STREAMING__FALLBACK_MODE=silent PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 NARWHALS_POLARS_GPU=1 \
    python -m pytest \
    --cache-clear \
