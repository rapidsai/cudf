...
cdef class Unbounded:
    ...
    def __cinit__(self):
        pass
    cdef cpp_rolling.unbounded view(self) noexcept nogil:
        return cpp_rolling.unbounded()
...
cdef class CurrentRow:
    ...
    def __cinit__(self):
        pass
    cdef cpp_rolling.current_row view(self) noexcept nogil:
        return cpp_rolling.current_row()
...
cdef class BoundedClosed:
    ...
    cdef unique_ptr[cpp_rolling.bounded_closed] view(self) noexcept nogil:
        return move(
            make_unique[cpp_rolling.bounded_closed](dereference(self.delta.get()))
        )
...
cdef class BoundedOpen:
    ...
    cdef unique_ptr[cpp_rolling.bounded_open] view(self) noexcept nogil:
        return move(
            make_unique[cpp_rolling.bounded_open](dereference(self.delta.get()))
        )
    ...
    if (
        ...
        with nogil:
            result = cpp_rolling.grouped_range_rolling_window(
                ...
                order,
                null_order,
                dereference(preceding.view().get()),
                dereference(following.view().get()),
                min_periods,
                crequests
            )
    elif (
