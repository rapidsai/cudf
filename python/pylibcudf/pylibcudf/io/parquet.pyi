...
class ParquetReaderOptionsBuilder:
    ...
    def column_names(self, col_names: list[str]) -> Self: ...
    def column_indices(self, col_indices: list[int]) -> Self: ...
    def column_field_ids(self, column_field_ids: list[int]) -> Self: ...
    def use_jit_filter(self, use_jit_filter: bool) -> Self: ...
    def case_sensitive_names(self, val: bool) -> Self: ...
    def decimal_width(self, width: TypeId) -> Self: ...
