...
def spark_strings():
    ...
    return pa.array(
        [
            "abc", "aabbc", "123abc", "abc123def", "a1b2c3",
            "boo:and:foo", "foo:boo:", "TEST", "TESTaaa", "TEST123",
            "abcd", "aaa", "bbb", "ccc", "abb", "ab", "aab",
            "a\nb", "a\tb", "a b", "",
            "aaabbb", "abcabc", "aa|bb", "foobar",
            "12345", "abcdef", "ABCDEF", "AbCdEf",
            None,
        ]
    )
...
def test_contains_re_nonword(regex_flags):
    arr = pa.array(["abc", "abc123", "abc!", "a b", "aa|bb", "12345", "", None])
    got = plc.strings.contains.contains_re(
