 ...
 * @return New string with characters removed
 */
__device__ udf_string lstrip(cudf::string_view const d_str, cudf::string_view d_to_strip)
{
  return strip(d_str, d_to_strip, side_type::LEFT);
}
 ...
 * @return New string with characters removed
 */
__device__ udf_string rstrip(cudf::string_view const d_str, cudf::string_view d_to_strip)
{
  return strip(d_str, d_to_strip, side_type::RIGHT);
}
