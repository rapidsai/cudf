...
cdef extern from "<cudf_streaming/streaming/bloom_filter.hpp>" nogil:
    cdef cppclass cpp_BloomFilter "cudf_streaming::streaming::BloomFilter":
        cpp_BloomFilter(
...
cdef extern from "<cudf_streaming/integrations/bloom_filter.hpp>" nogil:
