...
A "hello world" of using cuStreamz with python streamz can be found [here](https://github.com/rapidsai-community/notebooks-contrib/blob/release/26.04/getting_started_materials/hello_worlds/hello_streamz.ipynb)

A more detailed example of [parsing haproxy logs](https://github.com/rapidsai-community/notebooks-contrib/blob/release/26.04/the_archive/archived_rapids_demos/custreamz/parsing_haproxy_logs.ipynb) is also available.
