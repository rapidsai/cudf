...
NODEIDS_THAT_XPASS_WITH_CUDF_PANDAS = {
    ...
    "tests/extension/test_arrow.py::TestArrowArray::test_astype_str[timestamp[ms]]",
    "tests/extension/test_arrow.py::TestArrowArray::test_astype_str[timestamp[s]]",
    "tests/extension/test_arrow.py::TestArrowArray::test_concat_mixed_dtypes[decimal128(7, 3)]",
...
# TODO: Migrate all sections above to use this dictionary
FUTURE_NODEIDS_TO_SKIP: dict[str, str] = {
