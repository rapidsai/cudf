...
NODEIDS_THAT_FAIL_WITH_CUDF_PANDAS = {
    ...
    "tests/plotting/test_converter.py::TestDateTimeConverter::test_conversion_float - AssertionError: Input are different",
    ...
    "tests/plotting/test_converter.py::TestDateTimeConverter::test_conversion_float",
    "tests/io/excel/test_writers.py::TestFSPath::test_excelfile_fspath",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[string]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[datetime]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[datetime-tz]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[period]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[timedelta]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[range]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[int8]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[int16]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[int32]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[int64]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[uint8]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[uint16]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[uint32]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[uint64]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[float32]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[float64]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[bool-object]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[bool-dtype]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[complex64]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[complex128]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[categorical]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[interval]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[repeats]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[nullable_int]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[nullable_uint]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[nullable_float]",
    "tests/generic/test_to_xarray.py::TestSeriesToXArray::test_to_xarray_index_types[nullable_bool]",
