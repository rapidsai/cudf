...
@cuda_lower(
    "MaskedType.isalnum", MaskedType(string_view)
)
...
@cuda_lower(
    "MaskedType.isalpha", MaskedType(string_view)
)
...
@cuda_lower(
    "MaskedType.isdigit", MaskedType(string_view)
)
...
@cuda_lower(
    "MaskedType.isdecimal", MaskedType(string_view)
)
...
@cuda_lower(
    "MaskedType.isupper", MaskedType(string_view)
)
...
@cuda_lower(
    "MaskedType.islower", MaskedType(string_view)
)
...
@cuda_lower(
    "MaskedType.isspace", MaskedType(string_view)
)
