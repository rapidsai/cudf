...
def register_masked_lowering():
    cuda_lowering_registry.lower_constant(NAType)(constant_na)
    ...
    cuda_lower(len, MaskedType(string_view))(masked_len_impl)
    cuda_lower(len, MaskedType(udf_string))(masked_len_impl)
    cuda_lower(
        "MaskedType.replace",
        MaskedType(string_view),
        MaskedType(string_view),
        MaskedType(string_view),
    )(masked_string_view_replace_impl)

    create_masked_binary_string_func(
        "MaskedType.strip", strip_impl, udf_string
    )
    create_masked_binary_string_func(
        "MaskedType.lstrip", lstrip_impl, udf_string
    )
    create_masked_binary_string_func(
        "MaskedType.rstrip", rstrip_impl, udf_string
    )
    create_masked_binary_string_func(
