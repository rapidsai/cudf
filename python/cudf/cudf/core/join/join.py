...
class Merge:
    ...
    def __init__(
        ...
        *,
        ...
        left_on = lhs.index._data.names if left_index else left_on if left_on else on
        self._using_right_index = bool(right_index)
        right_on = (
            rhs.index._data.names if right_index else right_on if right_on else on
        )
    ...
    def _merge_results(self, left_result: cudf.DataFrame, right_result: cudf.DataFrame):
        ...
        common_names = set(left_result._data.names) & set(right_result._data.names)
