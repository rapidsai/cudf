...
_str_to_numeric_typecast_functions = {
    ...
    dtype("timedelta64[s]"): str_cast.timedelta2int,
    dtype("timedelta64[ms]"): str_cast.timedelta2int,
    dtype("timedelta64[us]"): str_cast.timedelta2int,
    dtype("timedelta64[ns]"): str_cast.timedelta2int,
}
...
_numeric_to_str_typecast_functions = {
    ...
    dtype("datetime64[s]"): str_cast.int2timestamp,
    dtype("datetime64[ms]"): str_cast.int2timestamp,
    dtype("datetime64[us]"): str_cast.int2timestamp,
    dtype("datetime64[ns]"): str_cast.int2timestamp,
    dtype("timedelta64[s]"): str_cast.int2timedelta,
    dtype("timedelta64[ms]"): str_cast.int2timedelta,
    dtype("timedelta64[us]"): str_cast.int2timedelta,
    dtype("timedelta64[ns]"): str_cast.int2timedelta,
}
