...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "DatetimeIndex(['1970-01-01 00:00:10', '1970-01-01 00:00:20',\n"
            "               '1970-01-01 00:00:30', '<NA>'],\n"
            "              dtype='datetime64[s]')",
        ),
        (
        ...
        (
            ...
            "DatetimeIndex(['<NA>', '<NA>', '<NA>', '<NA>', '<NA>', '<NA>', "
            "'<NA>',\n               '<NA>', '<NA>', '<NA>'],\n"
            "              dtype='datetime64[ms]')",
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "TimedeltaIndex(['0 days 00:16:40', '0 days 00:03:20', "
            "'0 days 00:50:00'],  dtype='timedelta64[ms]')",
        ),
        (
            cudf.Index(
        ...
        (
            ...
            "TimedeltaIndex(['1579 days 08:54:14', '<NA>', "
            "'2839 days 15:29:05',\n"
            "                '2586 days 00:33:31', '<NA>', "
            "'42066 days 12:52:14',\n                '0 days 06:27:14'],\n"
            "               dtype='timedelta64[s]')",
        ),
    ],
