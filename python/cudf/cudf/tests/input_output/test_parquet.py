...
def test_parquet_reader_select_nonexistent_column_error():
    df = cudf.DataFrame(
        {
            "a": [1, 2, 3, 4, 5, 6],
    ...
    with pytest.raises(
        ...
        cudf.read_parquet(buf, columns=["a", "d"])
    ...
    dfs = [
        ...
        (
            ...
            [
                ...
                ["struct.list"],
                ["struct.list.element"],
                ["struct.list.element.a"],
                ["struct.list.element.b"],
            ],
        ),
        # struct with "." in field names (stick to exact fields that exist)
        (
            [
                {"a.b": 1, "b.a": 2},
                {"a.b": 10, "b.a": 20},
