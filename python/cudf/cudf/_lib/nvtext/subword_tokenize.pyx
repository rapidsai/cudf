...
def subword_tokenize(Column strings, hash_file, max_sequence_length=64,
                     stride=48, do_lower=True, do_truncate=False,
                     max_num_strings=100, max_num_chars=100000,
                     max_rows_tensor=500):
    ...
    # return 3 components of c_result as rmm.DeviceBuffer's
    # c_result.device_tensor_tokenIDS
    # c_result.device_attention_mask
    # c_result.device_tensor_metadata
    return None
