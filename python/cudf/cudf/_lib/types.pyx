...
np_to_cudf_types = {
    ...
    np.dtype("uint8"): libcudf_types.UINT8,
    np.dtype("uint16"): libcudf_types.UINT16,
    np.dtype("uint32"): libcudf_types.UINT32,
    np.dtype("uint64"): libcudf_types.UINT64,
...
cudf_to_np_types = {
    ...
    libcudf_types.UINT8: np.dtype("uint8"),
    libcudf_types.UINT16: np.dtype("uint16"),
    libcudf_types.UINT32: np.dtype("uint32"),
    libcudf_types.UINT64: np.dtype("uint64"),
