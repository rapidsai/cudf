...
cdef extern from "cudf/aggregation.hpp" namespace "cudf" nogil:
    ...
    cdef unique_ptr[T] make_ewmvar_aggregation[T](double com, bint adjust, bint bias) except +

    cdef unique_ptr[T] make_ewmstd_aggregation[T](double com, bint adjust, bint bias) except +
