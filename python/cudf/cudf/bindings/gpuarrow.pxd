...
from cudf.bindings.arrow._cuda cimport *
...
cdef extern from "cudf/ipc.hpp" nogil:
    ...
    # Cython type signatures. They're declaring shared_ptr[CRecordBatchStreamReader]* out,
    # but the actual type in Arrow C++ is `shared_ptr[CRecordBatchReader]* out`,
    # like we have here
