...
class DataFrame(_Frame, dd.core.DataFrame):
    ...
    def repartition_by_hash(
        ...
        **kwargs,
        ...
        dynamic_tasks : bool, default False
            If True, all-to-all components of the task-graph will be
            dynamically generated by the distributed scheduler. The dynamic
            task generation will only occur if `npartitions>2*max_branch`.
        kwargs : dict
