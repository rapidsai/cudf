...
def test_expression_equality_not_expression():
    col = expr.Col(DType(pl.datatypes.Int8()), "a")
...
def test_column_ne_dtypes_differ(dtype):
    a = expr.Col(DType(dtype), "a")
    b = expr.Col(DType(pl.datatypes.Float32()), "a")
    assert a != b
...
def test_column_eq_names_eq(dtype):
    a = expr.Col(DType(dtype), "a")
    b = expr.Col(DType(dtype), "a")
    assert a == b


def test_expr_hashable():
    a = expr.Col(DType(pl.datatypes.Int8()), "a")
    b = expr.Col(DType(pl.datatypes.Int8()), "b")
    c = expr.Col(DType(pl.datatypes.Float32()), "c")
...
def test_namedexpr_hashable():
    b = expr.NamedExpr("b", expr.Col(DType(pl.datatypes.Int8()), "a"))
    c = expr.NamedExpr("c", expr.Col(DType(pl.datatypes.Int8()), "a"))
...
def test_namedexpr_ne_values():
    b1 = expr.NamedExpr("b1", expr.Col(DType(pl.datatypes.Int8()), "a"))
    b2 = expr.NamedExpr("b2", expr.Col(DType(pl.datatypes.Int16()), "a"))
...
def test_namedexpr_repr_stable():
    b1 = expr.NamedExpr("b1", expr.Col(DType(pl.datatypes.Int8()), "a"))
    b2 = expr.NamedExpr("b1", expr.Col(DType(pl.datatypes.Int8()), "a"))
...
def test_equality_cse():
    ...
    def make_expr(n1, n2):
        a = expr.Col(DType(pl.datatypes.Int8()), n1)
        b = expr.Col(DType(pl.datatypes.Int8()), n2)
...
def test_reconstruct_named_expr():
    ne1 = expr.NamedExpr("a", expr.Col(DType(pl.datatypes.Int8()), "a"))
    new_value = expr.Col(DType(pl.datatypes.Int16()), "a")
