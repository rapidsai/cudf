...
EXPECTED_FAILURES: Mapping[str, str | tuple[str, bool]] = {
    ...
    "tests/unit/io/test_delta.py::test_scan_delta_nanosecond_timestamp": "polars cpu result has incorrect schema",
    "tests/unit/io/test_delta.py::test_scan_delta_nanosecond_timestamp_nested": "polars cpu result has incorrect schema",
    ...
    "tests/unit/operations/test_join.py::test_join_filter_pushdown_iejoin": "Need to match polars cpu sort order",
    ...
    "tests/unit/operations/namespaces/test_categorical.py::test_cat_uses_lexical_ordering": "DeprecationWarning: the physical Categorical ordering is deprecated. The ordering is now always lexical. (Deprecated in version 1.32.0)",
    "tests/unit/functions/test_repeat.py::test_repeat_n_empty": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/functions/test_repeat.py::test_repeat_nonscalar_value[value0]": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/functions/test_repeat.py::test_repeat_nonscalar_value[value1]": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/functions/test_repeat.py::test_repeat_nonscalar_n[n0]": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/functions/test_repeat.py::test_repeat_nonscalar_n[n1]": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/operations/test_diff.py::test_diff_scalarity": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/operations/test_extend_constant.py::test_extend_constant[1-Int8]": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/operations/test_extend_constant.py::test_extend_constant[4-UInt32]": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/operations/test_extend_constant.py::test_extend_constant[4.5-Float32]": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/operations/test_extend_constant.py::test_extend_constant[None-Float64]": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/operations/test_extend_constant.py::test_extend_constant[\\u767d\\u9d6c\\u7fd4-String]": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/operations/test_extend_constant.py::test_extend_constant[const5-Date]": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/operations/test_extend_constant.py::test_extend_constant[const6-dtype6]": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/operations/test_extend_constant.py::test_extend_constant[const7-Time]": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/operations/test_extend_constant.py::test_extend_constant[const8-dtype8]": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/operations/test_extend_constant.py::test_extend_by_not_uint_expr": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/operations/test_shift.py::test_shift_n_nonscalar": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
    "tests/unit/operations/test_shift.py::test_shift_fill_value_nonscalar": "Incorrect exception type raised got: ComputeError, expected: ShapeError",
}
