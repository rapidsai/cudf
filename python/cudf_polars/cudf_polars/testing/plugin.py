...
EXPECTED_FAILURES: Mapping[str, str | tuple[str, bool]] = {
    ...
    "tests/unit/lazyframe/test_lazyframe.py::test_predicate_count_vstack": "over(...) inside filter is not supported for multiple partitions; falling back to in-memory evaluation.",
