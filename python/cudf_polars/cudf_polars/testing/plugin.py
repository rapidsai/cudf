...
EXPECTED_FAILURES: Mapping[str, str | tuple[str, bool]] = {
    ...
    "tests/unit/io/test_sink.py::test_mkdir[in-memory-scan_parquet-sink_parquet]": "Sink not supported for gpu engine.",
    "tests/unit/io/test_sink.py::test_mkdir[in-memory-scan_csv-sink_csv]": "Sink not supported for gpu engine.",
    "tests/unit/io/test_sink.py::test_mkdir[in-memory-scan_ndjson-sink_ndjson]": "Sink not supported for gpu engine.",
    "tests/unit/io/test_sink.py::test_mkdir[streaming-scan_ipc-sink_ipc]": "Sink not supported for gpu engine.",
    "tests/unit/io/test_sink.py::test_mkdir[streaming-scan_parquet-sink_parquet]": "Sink not supported for gpu engine.",
    "tests/unit/io/test_sink.py::test_mkdir[streaming-scan_csv-sink_csv]": "Sink not supported for gpu engine.",
    "tests/unit/io/test_sink.py::test_mkdir[streaming-scan_ndjson-sink_ndjson]": "Sink not supported for gpu engine.",
    "tests/unit/io/test_write.py::test_write_async[<lambda>-<lambda>1]": "Sink not supported for gpu engine.",
    "tests/unit/io/test_write.py::test_write_async_force_async[Path-read_parquet-<lambda>]": "Sink not supported for gpu engine.",
    "tests/unit/io/test_write.py::test_write_async_force_async[Path-<lambda>-<lambda>0]": "Sink not supported for gpu engine.",
    "tests/unit/io/test_write.py::test_write_async_force_async[Path-<lambda>-<lambda>1]": "Sink not supported for gpu engine.",
    "tests/unit/io/test_write.py::test_write_async_force_async[Path-<lambda>-<lambda>2]": "Sink not supported for gpu engine.",
    "tests/unit/io/test_write.py::test_write_async_force_async[absolute-read_parquet-<lambda>]": "Sink not supported for gpu engine.",
    "tests/unit/io/test_write.py::test_write_async_force_async[absolute-<lambda>-<lambda>0]": "Sink not supported for gpu engine.",
    "tests/unit/io/test_write.py::test_write_async_force_async[absolute-<lambda>-<lambda>1]": "Sink not supported for gpu engine.",
    "tests/unit/io/test_write.py::test_write_async_force_async[absolute-<lambda>-<lambda>2]": "Sink not supported for gpu engine.",
    "tests/unit/io/test_parquet.py::test_parquet_array_statistics": "Sink not supported for gpu engine.",
    "tests/unit/streaming/test_streaming.py::test_elementwise_identification_in_ternary_15767": "Sink not supported for gpu engine.",
    "tests/unit/streaming/test_streaming_io.py::test_sink_parquet": "Sink not supported for gpu engine.",
    "tests/unit/streaming/test_streaming_io.py::test_sink_parquet_10115": "Sink not supported for gpu engine.",
    "tests/unit/streaming/test_streaming_io.py::test_sink_ipc": "Sink not supported for gpu engine.",
    "tests/unit/streaming/test_streaming_io.py::test_sink_csv": "Sink not supported for gpu engine.",
    "tests/unit/streaming/test_streaming_io.py::test_sink_csv_14494": "Sink not supported for gpu engine.",
