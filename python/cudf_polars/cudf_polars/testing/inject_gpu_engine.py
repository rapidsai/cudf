...
EXPECTED_FAILURES: Mapping[str, str] = {
    ...
    "tests/unit/lazyframe/test_predicates.py::test_hconcat_predicate": "polars 1.42.1: how='horizontal' in concat triggers DeprecationWarning, fails on CPU too",
    "tests/unit/functions/test_union.py::test_union_lazyframe_horizontal": "polars 1.42.1: how='horizontal' in union triggers DeprecationWarning, fails on CPU too",
