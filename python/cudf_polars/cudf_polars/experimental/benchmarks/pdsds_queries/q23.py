...
def polars_impl(run_config: RunConfig) -> QueryResult:
    ...
    frequent_ss_items = (
        store_sales.join(date_dim_years, left_on="ss_sold_date_sk", right_on="d_date_sk")
    ...
    customer_sales = (
        ...
        .join(date_dim_years.select("d_date_sk"), left_on="ss_sold_date_sk", right_on="d_date_sk")
