...
if [[ "${INSTALL_DASK_MAIN}" == 1 ]]; then
    ...
    rapids-logger "rapids-mamba-retry install conda-forge::dask=={$DASK_STABLE_VERSION} conda-forge::distributed>=2023.5.1 conda-forge::dask-core>=2023.5.1 --force-reinstall"
    rapids-mamba-retry install conda-forge::dask=={$DASK_STABLE_VERSION} conda-forge::distributed>="2023.5.1" conda-forge::dask-core=="2023.5.1" --force-reinstall
fi
