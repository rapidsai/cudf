            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i102 in range(_size98):
                        _elem103 = TColumnType()
                        _elem103.read(iprot)
                        self.row_desc.append(_elem103)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
...
class TPendingQuery(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i109 in range(_size105):
                        _elem110 = TColumnRange()
                        _elem110.read(iprot)
                        self.column_ranges.append(_elem110)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i115 in range(_size111):
                        _elem116 = TDictionaryGeneration()
                        _elem116.read(iprot)
                        self.dictionary_generations.append(_elem116)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i121 in range(_size117):
                        _elem122 = TTableGeneration()
                        _elem122.read(iprot)
                        self.table_generations.append(_elem122)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.column_ranges is not None:
            ...
            for iter123 in self.column_ranges:
                iter123.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.dictionary_generations is not None:
            ...
            for iter124 in self.dictionary_generations:
                iter124.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.table_generations is not None:
            ...
            for iter125 in self.table_generations:
                iter125.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TDataBlockPtr(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i130 in range(_size126):
                        _elem131 = TVarLen()
                        _elem131.read(iprot)
                        self.var_len_data.append(_elem131)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.var_len_data is not None:
            ...
            for iter132 in self.var_len_data:
                iter132.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TInsertData(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i137 in range(_size133):
                        ...
                        self.column_ids.append(_elem138)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i143 in range(_size139):
                        _elem144 = TDataBlockPtr()
                        _elem144.read(iprot)
                        self.data.append(_elem144)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.column_ids is not None:
            ...
            for iter145 in self.column_ids:
...
class TRawPixelDataResult(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i151 in range(_size147):
                        ...
                        _val153 = TRawRenderPassDataResult()
                        _val153.read(iprot)
                        self.render_pass_map[_key152] = _val153
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
    ...
    def write(self, oprot):
        ...
        if self.render_pass_map is not None:
            ...
            for kiter154, viter155 in self.render_pass_map.items():
